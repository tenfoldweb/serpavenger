...
class GrabzItClient
{
	...
	*/
	public function SetImageOptions($url, $customId = null, $browserWidth = null, $browserHeight = null, $width = 500, $height = null, $format = null, $delay = null, $targetElement = null, $requestAs = 0, $customWaterMarkId = null, $quality = -1, $country = null)
	{
	...
	*/
	public function Save($callBackURL = null,$proxy=null)
	{
		...
		if($proxy)
		$obj = $this->getResultObject($this->Get($currentRequest,$proxy));
		else
	...
	*/
	...
	private function Get($url,$proxy=null)
	{
		...
		else
		{
			...
			curl_setopt($ch, CURLOPT_PROXY, 'billing19:nCh59iAt@'.$proxy);
			$data = curl_exec($ch);
