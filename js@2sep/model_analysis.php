...
$crawl_server="TC.isCrawlByBing = 1";
    ...
    WHERE CG.campaign_id = TC.campaign_id
      ...
      AND ".$crawl_server." "
      .$date_WC." "
      . $WC . " GROUP BY ageType " . " ORDER BY rank LIMIT 0, 10";
...
$crawl_server="TC.isCrawlByBing = 1";
	...
	public function renderUsersDomainExternalLinks($campaign_list, $campaign_server_engine){
		...
		$record['maxExtrnLink']="";$record['minExtrnLink']="";$record['avgExtrnLink']="";$record['percent']= "";
...
*/	
	...
	function rendersitefressness($campaign_list, $campaign_server_engine){
		$user_id		= $this->session->userdata("LOGIN_USER");
		$rec			= FALSE;
		$record			= FALSE;
		...
		//print_r($graph_week_arr);
		//print_r($graph_month_arr);
