         ...
         success: function(data){
            ...
            if (Object.keys(data.new).length >0 && Object.keys(data.new.current).length >0 && Object.keys(data.new.past).length >0) {
                ...
                if (Number(data.new.current.top_three.title) >= Number(data.new.past.top_three.title) ) {
                    new_site_str+='<img src="http://axattechnologies.in/demo/serp-new/images/green-arrow.png">';    
                }else{
                    new_site_str+='<img src="http://axattechnologies.in/demo/serp-new/images/green-arrow.png">';
                }
                new_site_str+='</p></td>';
                ...
                new_site_str +='<td><p>0%<img src="http://axattechnologies.in/demo/serp-new/images/red-arrow.png"></p></td>';
            ...
            if (Object.keys(data.old).length >0 && Object.keys(data.old.current).length >0 && Object.keys(data.old.past).length >0) {
                ...
                if (Number(data.old.current.top_three.title) >= Number(data.old.past.top_three.title) ) {
                    old_site_str+='<img src="http://axattechnologies.in/demo/serp-new/images/green-arrow.png">';    
                }else{
                    old_site_str+='<img src="http://axattechnologies.in/demo/serp-new/images/red-arrow.png">';
                }
                old_site_str+='';
                ...
                old_site_str +='<td><p>0%<img src="http://axattechnologies.in/demo/serp-new/images/red-arrow.png">';
                ...
                old_site_str +='<td><p>0%<img src="http://axattechnologies.in/demo/serp-new/images/red-arrow.png"></p></td>';
