function _renderSiteAge(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/siteage',
        data: dataString,
        beforesend: function(){
        ...
        success: function(data){
           ...
           //return false;
            ...
            if((Number(data.avg)/365) > 0){
						strAvgAge	= (Number(data.avg)/365) + ' Years';
					}else if((data.avg/30) > 0){
						strAvgAge	= (Number(data.avg)/30) + ' Months';
					}else{
						strAvgAge	= Number(data.avg) + ' Days';
					}
...
$('#loader-site-page-count').show();
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitepagecount',
        data: dataString,
        beforesend: function(){
...
function _renderSiteWordCount(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitewordcount',
        data: dataString,
        beforesend: function(){
...
function _renderSiteKWRatio(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitekwratio',
        data: dataString,
        beforesend: function(){
...
function _renderSiteKWOptimization(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitekwoptimization',
        data: dataString,
        beforesend: function(){
...
function _renderSiteHidingLinks(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitehidinglinks',
        data: dataString,
        beforesend: function(){
...
function _renderSocialLinks(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/socialLinks',
        data: dataString,
        beforesend: function(){
...
function _renderSiteExternalLinks(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/siteexternallinks',
        data: dataString,
        beforesend: function(){
...
function _renderSiteExactKWAnchor(base_url,type){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/siteexactkwanchors',
        data: dataString,
        beforesend: function(){
...
function _renderSiteLongTermPageOneRank(base_url){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitelongtermpageonerank',
        data: dataString,
        beforesend: function(){
...
function _renderSiteStat(base_url){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/siteStat',
        data: dataString,
        beforesend: function(){
...
function _renderSiteOnPageElement(base_url){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/randeronpageelement',
        data: dataString,
        beforesend: function(){
...
function _renderSiteLinkElement(base_url){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitelinkelement',
        data: dataString,
        beforesend: function(){
		...
		//alert(data);
           ...
           var str2 = '<div class="roundPaiSec"><div class="roundPaiIn" style="transform:rotate('+data.NoFollow+'deg);-moz-transform:rotate('+data.NoFollow+'deg); -webkit-transform:rotate('+data.NoFollow+'deg); -o-transform:rotate('+data.NoFollow+'deg); -ms-transform:rotate('+data.NoFollow+'deg)"></div></div>';
           $('#canvasFollow').html(str2);
           
           var str3 = '<div class="roundPaiSec"><div class="roundPaiIn" style="transform:rotate('+data.SiteWide+'deg);-moz-transform:rotate('+data.SiteWide+'deg); -webkit-transform:rotate('+data.SiteWide+'deg); -o-transform:rotate('+data.SiteWide+'deg); -ms-transform:rotate('+data.SiteWide+'deg)"></div></div>';
           $('#canvasSiteWide').html(str3);
           
           var str4 = '<div class="roundPaiSec"><div class="roundPaiIn" style="transform:rotate('+data.Text+'deg);-moz-transform:rotate('+data.Text+'deg); -webkit-transform:rotate('+data.Text+'deg); -o-transform:rotate('+data.Text+'deg); -ms-transform:rotate('+data.Text+'deg)"></div></div>';
...
function _renderSiteAnalysisComparison(base_url) {
           ...
           //alert(keyword_value); 
            ...
            $.ajax({
                type: 'post',
                url: base_url + 'renderanalysis_beas/siteanalysiscomparison',
                data: dataString,
                beforesend: function(){
...
function _renderSerpMeter(base_url) {
            ...
            $.ajax({
                type: 'post',
                url: base_url + 'renderanalysis_beas/renderserpmeter',
                data: dataString,
                beforesend: function(){
...
function _renderLongTermSite(base_url){
    ...
    $.ajax({
        type: 'post',
        url: base_url + 'renderanalysis_beas/sitelongterm',
        data: dataString,
        beforesend: function(){
...
function _renderLinkGraphSite(base_url) {
      ...
      var campaign_server_engine      = $('#campaign_server_engine').val();
        ...
        $.ajax({
            type: 'post',
            url: base_url + 'renderanalysis_beas/siteLinkGraph',
            data: dataString,
            beforesend: function(){
...
function _renderSiteFreshness(base_url ,type){
    ...
    var campaign_server_engine      = $('#campaign_server_engine').val();
        ...
        $.ajax({
            type: 'post',
            url: base_url + 'renderanalysis_beas/sitefraceness',
            data: dataString,
            beforesend: function(){
...
$(document).ready(function(){
  ...
  $('#btn-search').click(function(){
            ...
            if (search_keyword != '' && search_url != '') {
                    ...
                    $.ajax({
                            type: 'post',
                            url: base_url + 'renderanalysis_beas/secrawl',
                            data: dataString,
                            beforeSend: function(){
