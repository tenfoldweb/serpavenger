...
(function() {
    ...
    ka.prototype = {
        ...
        g, h, i) {
            ...
            var m = this, n = m.g(i), p = m.text("", 0, 0, g).attr({
                zIndex: 1
            }), u, o, G = 0, x = 3, w = 0, bb, Eb, Fb, Gb, Ub = 0, D = {}, U, z;
            n.onAdd = function() {
                p.add(n);
                n.attr({
                    text: a || "",
    ...
    Za.prototype = {
        ...
        getLabelSides: function() {
            ...
            a = c ? a.width: a.height, b = c ? d.x - a * {
                left: 0,
                center: 0.5,
                right: 1
            }
    ...
    L.prototype = {
        ...
        setTickPositions: function(a) {
            ...
            if (e)!a && z(b.min, o(b.dataMin, b.min)) <= 0 && qa(10, 1)
                , b.min = ha(Ga(b.min)), b.max = ha(Ga(b.max));
            if (b.range && t(b.max))
            ...
            if (!a)!b.ordinalPositions && (b.max - b.min) / b.tickInterval > w(2 * b.len, 200) && qa(19, !0)
                , a = f ? b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), p &&
        ...
        render: function() {
            ...
            if (s || h)
                ...
                q(a.getMinorTickPositions(), function(b) {
                    ...
                    , (b && c ||!b&&!c) && k.reverse(), z && (k = k.slice(1).concat([k[0]])), q(k, function(b, c) {
    ...
    L.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5)
            ...
            } else if (b = oa(b), c = oa(c)
                , a = e[d ? "minorTickInterval": "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = sb(a, null, rb(a)), g = xa(this.getLinearTickPositions(a, b, c), Ga), !d)this._minorAutoInterval = a / 5;
        if (!d)
            this.tickInterval = a;
        return g
    };
    ...
    Hb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            h = a.series;
            this.distance =
            o(h.tooltipOptions.distance,
            16);
            i===!1 ? this.hide(): (this.isHidden && (eb(d),
            d.attr("opacity",
            1).show()),
            d.attr({
                text: i
    ...
    pb.prototype = {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker)
                    for (k in i.stroke = h, g = a.convertAttribs(g)
                        , g)d = g[k], d !== r && (i[k] = d);
                f.attr(i)
            }
        },
        ...
        positionCheckboxes: function(a) {
            ...
            if (b)
                ...
                var f = e.checkbox, g;
                f && (g = c + f.y + (a || 0) + 3, E(f, {
                    left : b.translateX + e.checkboxOffset + f.x-20 + "px", top : g + "px", display : g > c-6 && g < c + d-6 ? "" : Y
                }))
            })
        },
    ...
    K.prototype = {
        ...
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)
                if (k = c[l], j = a[l], i = j !== null && j !== r && (!b.isLog || j.length || j > 0)
                    , k = this.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l-1] || k) <= h, i && k)if (i = j.length)
                for (; i--;)
                    j[i] !== null && (e[f++] = j[i]);
            else 
                e[f++] = j;
            ...
            if (d.enabled!==!1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = S(g.plotX)
                        , e = g.plotY, j = g.graphic, i = g.marker || {}, a = p && i.enabled === r || i.enabled, m = c.isInsidePlot(s(d), e, c.inverted), a && e !== r&&!isNaN(e) && g.y !== null)if (a =
            g.pointAttr[g.selected ? "select": ""] || l, h = a.r, i = o(i.symbol, this.symbol)
                , k = i.indexOf("url") === 0, j)j[m ? "show": "hide"](!0).animate(v({
                x: d - h,
                y: e - h
            }, j.symbolName ? {
                width: 2 * h,
    ...
    K.prototype.setPercentStacks = function() {
        ...
        q([b, "-" + b], function(b) {
            ...
            for (var f = d.length, g, h; f--;)
                if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e)h = h.total ? 100 / h.total : 0, g[0] = ha(g[0] * h), g[1] = ha(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    v(va.prototype, {
    ...
    O(L.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        ...
        if (h && a.unitRange <= H.hour) {
            k = o.length-1;
            for (i = 1; i < k; i++)(new Date(o[i] - La)
                )[Ua]() !== (new Date(o[i-1] - La))[Ua]() && (l[o[i]] = "day", m=!0);
            m && (l[o[0]] = "day");
            a.higherRanks = l
        }
        o.info = a;
        if (h && t(s)) {
            ...
            for (m = [];
            h--;
            )i = this.translate(o[h]), x && (m[h] = x - i)
                , k[h] = x = i;
            m.sort();
            m = m[S(m.length / 2)];
            m < s * 0.6 && (m = null);
    ...
    "pan", function(a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            var f = this.mouseDownX, g = c.getExtremes(), h = g.dataMax, i = g.min, k = g.max, j = this.hoverPoints, l = c.closestPointRange, f = (f - d) / (c.translationSlope * (c.ordinalSlope || l)), m = {
    ...
    C.flags = ga(C.column, {
        ...
        drawPoints: function() {
            ...
            for (k = c.length; k--;)
                if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m : - m)
                    , l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== r && (f = j.plotY + h + m - (l !== r && l * g.stackDistance)), n = l ? r : j.plotX + m, o = l ? r : j.plotY, l = j.graphic, f !== r &&
    ...
    yb.prototype = {
        ...
        init: function() {
            ...
            f.xAxis, {
                ...
                id : "navigator-y-axis", alignTicks : !1, height : g, offset : 0, index : p, zoomEnabled : !1
    ...
    zb.prototype = {
        ...
        render: function(a, b) {
            ...
            m && (f = d.plotTop-45, j.align(v({
                y : f, width : j.offset, x : h && f < (h.y || 0) + h.height - d.spacing[0]?-40 : 0
            },
            i.inputPosition),
            !0,
            d.spacingBox),
