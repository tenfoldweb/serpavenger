function _renderSiteAge(base_url,type){
 //alert("test");
  ...
  // var u1= 'http://axattechnologies.in/demo/serp-new/index.php/';
  // alert(u1);
    $.ajax({ 
        type: 'post',
         url: base_url + 'renderanalysis/siteage',
        //url: u1 + 'renderanalysis/siteage',
        data: dataString,
        beforesend: function(){
        ...
        success: function(data){
           ...
           //return false;
            ...
            var strAvgAge=0;
            if((Number(data.avg)/365) > 0){
						strAvgAge	= (Number(data.avg)/365).toFixed(2) + ' Years';
					}else if((data.avg/30) > 0){
						strAvgAge	= (Number(data.avg)/30).toFixed(2) + ' Months';
					}else{
						strAvgAge	= Number(data.avg).toFixed(2) + ' Days';
					}
            var str = '<h3 id="site-age-heading">'+strAvgAge+'</h3>';
...
$('#avg_age_graph').html(data.avgAge);
...
$('#loader-site-page-count').show();
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/sitepagecount',
        data: dataString,
        beforesend: function(){
...
function _renderSiteWordCount(base_url,type){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/sitewordcount',
        data: dataString,
        beforesend: function(){
...
function _renderSiteKWRatio(base_url,type){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/sitekwratio',
        data: dataString,
        beforesend: function(){
...
function _renderSiteKWOptimization(base_url,type){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/sitekwoptimization',
        data: dataString,
        beforesend: function(){
...
function _renderSiteHidingLinks(base_url,type){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/sitehidinglinks',
        data: dataString,
        beforesend: function(){
...
function _renderSocialLinks(base_url,type){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/socialLinks',
        data: dataString,
        beforesend: function(){
        ...
        success: function(data){
           ...
           // return false;
            data = JSON.parse(data);          
              ...
              var str = '<h3 id="site-hiding-links-heading">Social Score '+data.social_score+' </h3>';
            str     += '<div class="mapArea">';
            str     +='<table width="100%" border="0" cellspacing="0" cellpadding="0" background="none">';
            str     +='<tr>';
            ...
            str     +='</tr></table>';
            str     +='<div class="wave" id="social_score_ave_data"></div>';
			...
			$("#social_score_ave_data").html(data.graph_avg);
            $('#social_score_ave_data').sparkline();
...
function _renderSiteExternalLinks(base_url,type){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/siteexternallinks',
        data: dataString,
        beforesend: function(){
...
function _renderSiteExactKWAnchor(base_url,type){
   ...
   // alert(campaign_server_engine);
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/siteexactkwanchors',
        data: dataString,
        beforesend: function(){
...
function _renderSiteStat(base_url){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/siteStat',
        data: dataString,
        beforesend: function(){
        ...
        success: function(data){
            ...
            new_str     +='<td><img src="http://axattechnologies.in/demo/serp-new/images/graph-small.gif" width="33" height="14" alt=""></td><td> '+data.new.top_three+'%</td>';
            new_str     +='</tr><tr>';
            new_str     +='<td>Top 10: </td>';
            new_str     +='<td>&nbsp;</td><td id="new_top_ten"></td>';
            new_str     +='<td><img src="http://axattechnologies.in/demo/serp-new/images/graph-small.gif" width="33" height="14" alt=""></td><td>'+data.new.top_ten+'%</td>';
            new_str     +='</tr></table>';
            ...
            rec_str     +='<td><img src="http://axattechnologies.in/demo/serp-new/images/graph-small.gif" width="33" height="14" alt=""></td><td> '+data.recovery.top_three+'%</td>'
            rec_str     +='</tr><tr>';
            rec_str     +='<td>Top 10: </td>';
            rec_str     +='<td>&nbsp;</td><td id="rec_top_ten"></td>';
            rec_str     +='<td><img src="http://axattechnologies.in/demo/serp-new/images/graph-small.gif" width="33" height="14" alt=""></td><td>'+data.recovery.top_ten+'%</td>'
            rec_str     +='</tr></table>';
            ...
            old_str     +='<td><img src="http://axattechnologies.in/demo/serp-new/images/graph-small.gif" width="33" height="14" alt=""></td><td> '+data.old.top_three+'%</td>'
            old_str     +='</tr><tr>';
            old_str     +='<td>Top 10: </td>';
            old_str     +='<td>&nbsp;</td><td id="old_top_ten"></td>';
            old_str     +='<td><img src="http://axattechnologies.in/demo/serp-new/images/graph-small.gif" width="33" height="14" alt=""></td><td>'+data.old.top_ten+'%</td>'
            old_str     +='</tr></table>';
...
function _renderSiteOnPageElement(base_url){
    ...
    $.ajax({
        ...
        //url: u1 + 'renderanalysis/randeronpageelement',
        data: dataString,
        beforesend: function(){
         ...
         success: function(data){
            ...
            data = JSON.parse(data);
            var main_str_top ='<div class="panel-body-tbl-onpage">';
                main_str_top +='<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered">';
                main_str_top +='<tr><td width="20%">&nbsp;</td>';
                main_str_top +='<td><p>Title/URL</p></td>';
              //  main_str_top +='URL</p></td>';
                main_str_top +='<td><p>Descr</p></td>';
                main_str_top +='<td><p>H1H2</p></td>';
               // main_str_top +='<td><p>H2</p></td>';
                main_str_top +='<td><p>Above Fold</p></td>';
                main_str_top +='<td><p>Image</p></td>';
                main_str_top +='<td><p>Words</p></td>';
                main_str_top +='<td><p>Min/ Max/KW%</p></td>';
               // main_str_top +='<td><p> KW%</p></td>';
                main_str_top +='<td><p>Min/ Max /Ext Link</p></td>';
            ...
            if (Object.keys(data.new).length >0 && Object.keys(data.new.current).length >0 && Object.keys(data.new.past).length >0) {
                ...
                if (Number(data.new.current.top_three.title) >= Number(data.new.past.top_three.title) ) {
                    new_site_str+='<img src="http://serpavenger.com/serp_avenger/images/green-arrow.png">';    
                }else{
                    new_site_str+='<img src="http://serpavenger.com/serp_avenger/images/green-arrow.png">';
                }
                new_site_str+='</p></td>';
                ...
                if (Number(data.new.current.top_three.url) >= Number(data.new.past.top_three.url) ) {
                    ...
                    new_site_str+='<img src="http://axattechnologies.in/demo/serp-new/images/red-arrow.png">';
                }
                new_site_str+='</p></td>';
                ...
                if (Number(data.new.current.top_three.dec) >= Number(data.new.past.top_three.dec) ) {
                    ...
                    new_site_str+='<img src="http://serpavenger.com/serp_avenger/images/red-arrow.png">';
                }
                new_site_str+='</p></td>';
                ...
                new_site_str +='<td><p>0%<img src="http://serpavenger.com/serp_avenger/images/red-arrow.png"></p></td>';
                ...
                new_site_str = '<div class="panel-body-tbl-onpage"><table width="100%" cellspacing="0" cellpadding="0" border="1" class="table-bordered"><tbody><tr><td width="20%">&nbsp;</td><td><p>Title/URL</p></td><td><p>Descr</p></td><td><p>H1H2</p></td><td><p>Above Fold</p></td><td><p>Image</p></td><td><p>Words</p></td><td><p>Min/ Max/KW%</p></td><td><p>Min/ Max/Ext Link</p></td></tr><tr><td colspan="13">No Results</td></tr></tbody></table></div>';
            }
            ...
            if (Object.keys(data.old).length >0 && Object.keys(data.old.current).length >0 && Object.keys(data.old.past).length >0) {
                ...
                if (Number(data.old.current.top_three.title) >= Number(data.old.past.top_three.title) ) {
                    old_site_str+='<img src="http://serpavenger.com/serp_avenger/images/green-arrow.png">';    
                }else{
                    old_site_str+='<img src="http://serpavenger.com/serp_avenger/images/red-arrow.png">';
                }
                old_site_str+='';
                
                old_site_str+=''+data.old.current.top_three.url+'%';
                ...
                old_site_str+='';
                old_site_str +=''+data.old.current.top_three.h2+'%';
                ...
                old_site_str +='<td><p>0%<img src="http://serpavenger.com/serp_avenger/images/red-arrow.png">';
                ...
                old_site_str+='<td><p>'+data.old.current.top_three.min_word+'/'+data.old.current.top_three.max_word+'<img src="http://axattechnologies.in/demo/serp-new/images/green-arrow.png">';
                old_site_str+=''+data.old.current.top_three.kw+'%';
                ...
                old_site_str+='<td><p>'+data.old.current.top_three.min_kw+'%/'+data.old.current.top_three.max_kw+'%<img src="http://axattechnologies.in/demo/serp-new/images/green-arrow.png">';
                old_site_str+=''+data.old.current.top_three.el_percent+'%';
                ...
                old_site_str+=''+data.old.current.top_ten.url+'%';
                ...
                old_site_str+='';
                old_site_str +=''+data.old.current.top_ten.h2+'%';
                ...
                old_site_str +='<td><p>0%<img src="http://serpavenger.com/serp_avenger/images/red-arrow.png"></p></td>';
                ...
                old_site_str+='<td><p>'+data.old.current.top_ten.min_word+'/'+data.old.current.top_ten.max_word+'<img src="http://axattechnologies.in/demo/serp-new/images/green-arrow.png">';
                old_site_str+=''+data.old.current.top_ten.kw+'%';
                ...
                old_site_str+='<td><p>'+data.old.current.top_ten.min_kw+'%/'+data.old.current.top_ten.max_kw+'%<img src="http://axattechnologies.in/demo/serp-new/images/green-arrow.png">';
                old_site_str+=''+data.old.current.top_ten.el_percent+'%';
                ...
                old_site_str = '<div class="panel-body-tbl-onpage"><table width="100%" cellspacing="0" cellpadding="0" border="1" class="table-bordered"><tbody><tr><td width="20%">&nbsp;</td><td><p>Title/URL</p></td><td><p>Descr</p></td><td><p>H1H2</p></td><td><p>Above Fold</p></td><td><p>Image</p></td><td><p>Words</p></td><td><p>Min/ Max/KW%</p></td><td><p>Min/ Max/Ext Link</p></td></tr><tr><td colspan="13">No Results</td></tr></tbody></table></div>';
            }
            ...
            if (Object.keys(data.long).length >0 && Object.keys(data.long.current).length >0 && Object.keys(data.long.past).length >0) {
                ...
                long_site_str = '<div class="panel-body-tbl-onpage"><table width="100%" cellspacing="0" cellpadding="0" border="1" class="table-bordered"><tbody><tr><td width="20%">&nbsp;</td><td><p>Title/URL</p></td><td><p>Descr</p></td><td><p>H1H2</p></td><td><p>Above Fold</p></td><td><p>Image</p></td><td><p>Words</p></td><td><p>Min/ Max/KW%</p></td><td><p>Min/ Max/Ext Link</p></td></tr><tr><td colspan="13">No Results</td></tr></tbody></table></div>';
            }
...
function _renderSiteLinkElement(base_url){
    ...
    $.ajax({
        type: 'post',
        url: u1 + 'renderanalysis/sitelinkelement',
        data: dataString,
        beforesend: function(){
        ...
        success: function(data){          
           data = JSON.parse(data);
           //alert(data.NotRedirect);
           var str1 = '<div class="roundPaiSec"><div class="roundPaiIn" style="transform:rotate('+data.Redirect+'deg);-moz-transform:rotate('+data.Redirect+'deg); -webkit-transform:rotate('+data.Redirect+'deg); -o-transform:rotate('+data.Redirect+'deg); -ms-transform:rotate('+data.Redirect+'deg)"></div></div>';
           $('#canvas301Redirect').html(str1);
           
           var str2 = '<div class="roundPaiSec"><div class="roundPaiIn1" style="transform:rotate('+data.NoFollow+'deg);-moz-transform:rotate('+data.NoFollow+'deg); -webkit-transform:rotate('+data.NoFollow+'deg); -o-transform:rotate('+data.NoFollow+'deg); -ms-transform:rotate('+data.NoFollow+'deg)"></div></div>';
           $('#canvasFollow').html(str2);
           
           var str3 = '<div class="roundPaiSec"><div class="roundPaiIn2" style="transform:rotate('+data.SiteWide+'deg);-moz-transform:rotate('+data.SiteWide+'deg); -webkit-transform:rotate('+data.SiteWide+'deg); -o-transform:rotate('+data.SiteWide+'deg); -ms-transform:rotate('+data.SiteWide+'deg)"></div></div>';
           $('#canvasSiteWide').html(str3);
           
           var str4 = '<div class="roundPaiSec"><div class="roundPaiIn3" style="transform:rotate('+data.Text+'deg);-moz-transform:rotate('+data.Text+'deg); -webkit-transform:rotate('+data.Text+'deg); -o-transform:rotate('+data.Text+'deg); -ms-transform:rotate('+data.Text+'deg)"></div></div>';
           $('#canvasTextImage').html(str4);
...
function _renderSiteAnalysisComparison(base_url) {
           ...
           //alert(keyword_value); 
            ...
            $.ajax({
                type: 'post',
                url: base_url + 'renderanalysis/siteanalysiscomparison',
                data: dataString,
                beforesend: function(){
                ...
                success: function(data){
                    ...
                    $('#keyword_ratio').text(data.kw_ratio);
                    $('#keyword_title').text(data.kw_title);
                    $('#keyword_desc').text(data.kw_desc);
                    $('#keyword_h1').text(data.kw_h1);
                    ...
                    $('#comparision_image').attr('src', data.campaign_murl_thumb);
                }
            });
}
...
function _renderSerpMeter(base_url) {
            ...
            $.ajax({
                type: 'post',
                url: base_url + 'renderanalysis/renderserpmeter',
                data: dataString,
                beforesend: function(){
                ...
                success: function(data){
                    ...
                    data = JSON.parse(data);
                    //alert(data.today);
                    if (parseInt(data.today) <= 0){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-0.gif');
                    }else if (parseInt(data.today) > 0 && parseInt(data.today) <= 10){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-10.gif');
                    }else if (parseInt(data.today) > 10 && parseInt(data.today) <= 20){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-20.gif');
                    }else if (parseInt(data.today) > 20 && parseInt(data.today) <= 30){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-30.gif');
                    }else if (parseInt(data.today) > 30 && parseInt(data.today) <= 40){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-40.gif');
                    }else if (parseInt(data.today) > 40 && parseInt(data.today) <= 50){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-50.gif');
                    }else if (parseInt(data.today) > 50 && parseInt(data.today) <= 60){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-60.gif');
                    }else if (parseInt(data.today) > 60 && parseInt(data.today) <= 70){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-70.gif');
                    }else if (parseInt(data.today) > 70 && parseInt(data.today) <= 80){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-80.gif');
                    }else if (parseInt(data.today) > 80 && parseInt(data.today) <= 90){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-90.gif');
                    }else if (parseInt(data.today) > 90 && parseInt(data.today) <= 100){
                        $('#ranking_meter').attr('src', base_url + 'images/meter-100.gif');
                    }
                    $('#today_heading_meter').text(data.today);
                    $('#today_meter').text(data.today);
                    $('#yesterday_meter').text(data.yesterday);
                    $('#week_meter').text(data.week);
                    $('#month_meter').text(data.month);
...
function _renderLongTermSite(base_url){
    ...
    $.ajax({
        type: 'post',
        url: u1 + 'renderanalysis/sitelongterm',
        data: dataString,
        beforesend: function(){
        ...
        success: function(data){
           ...
           var str ="";
           str +='<div class="serpp-info">'+ data.percent_data +'% Ranking<br><span>  for 60+ Days</span> </div>';
...
function _renderLinkGraphSite(base_url) {
      ...
      var campaign_server_engine      = $('#campaign_server_engine').val();
        ...
        $.ajax({
            type: 'post',
            url: u1 + 'renderanalysis/siteLinkGraph',
            data: dataString,
            beforesend: function(){
            ...
            success: function(data){
                ...
                var str = '';
                str +='<div class="matchProgressdiv progressdiv clearfix ">';
                str +='<div class="matchProgressLt leftap">'
                str +='<span class="textMatch">Exact Match %</span>';
                str +='<p id="ex_match_link_graph"></p>'
                str +='</div>';
                str +='<div class="matchProgressRt rightap">';
                 str +='<div class="colorDiv">';
...
function _renderSiteFreshness(base_url ,type){
    ...
    var campaign_server_engine      = $('#campaign_server_engine').val();
        ...
        $.ajax({
            type: 'post',
            url: u1 + 'renderanalysis/sitefraceness',
            data: dataString,
            beforesend: function(){
            ...
            success: function(data){
                ...
                var str = '<h3 id="site-age-heading">Fresh Score '+((parseFloat(data.score) > 0) ? data.score : 100)+'</h3>';
                str     += '<div class="mapArea">';
                str     +='<table width="100%" border="0" cellspacing="0" cellpadding="0" background="none">';
                str     +='<tr>';
...
function _setDynmicData(base_url,type){
   ...
   _renderSiteAnalysisComparison(base_url);
    _renderSerpMeter(base_url);
...
$(document).ready(function(){
    var base_url_suffix	= 'serp-new/';
    var base_url = location.protocol + '//' + location.host + '/' + base_url_suffix;
    _setDynmicData(base_url,'top_ten')
  ...
  $("#top_ten_snape_shot").click(function(){
  	 $(".snap_shot_link").css("font-weight","normal");
  	 $(this).css("font-weight",'bold');
  ...
  $('#btn-search').click(function(){
            ...
            if (search_keyword != '' && search_url != '') {
                   ...
                   // alert(dataString);
                    $.ajax({
                            type: 'post',
                            url: base_url + 'renderanalysis/secrawl',
                            data: dataString,
                            beforeSend: function(){
