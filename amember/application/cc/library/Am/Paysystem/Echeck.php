...
abstract class Am_Paysystem_Echeck extends Am_Paysystem_Abstract
{
    ...
    protected function echeckActionValidateSetInvoice(Am_Request $request, array $invokeArgs)
    {
     ...
     */
    public function echeckAction(Am_Request $request, Zend_Controller_Response_Http $response, array $invokeArgs)
    {
