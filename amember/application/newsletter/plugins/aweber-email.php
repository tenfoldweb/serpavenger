...
instead of making API calls. To use this functionality, do the following:
  * Go to <a href='https://www.aweber.com/users/parser' target=_blank>www.aweber.com -> login -> My Lists -> Email Parser</a>
  * Scroll down to "Custom Parsers" and click <a href='https://www.aweber.com/users/parser/create' target=_blank>add new</a> link
  * Fill in fields:
