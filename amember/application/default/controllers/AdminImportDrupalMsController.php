...
class AdminImportDrupalMsController extends Am_Controller
{
    ...
    function indexAction()
    {
        ...
        if ($importer->run($done) === true)
        {
            ...
            $this->view->content .= "<br /><br/><a href='" . REL_ROOT_URL . "/admin-import-drupal-ms'>Continue to import other information</a>";
        ...
        {
            $this->redirectHtml(REL_ROOT_URL . "/admin-import-drupal-ms?done=$done&i=$import", "$done records imported");
        }
    }
