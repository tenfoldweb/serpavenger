...
return this.each(function(){
    ...
    // add [-] or [+] sign
    $("legend span", this)
        .before("<a class='collapse' href='javascript:'>[&minus;]</a>&nbsp;");
...
$(document).on("click",".billing-plan a.del", function(event){
...
$(document).on("click",".billing-plan a.add", function(event){
    var d = new Date();
    var newId = d.getTime();
...
$(document).on("click",".billing-plan a.collapse", function(event){
...
jQuery(document).ready(function($) {
    ...
    function serializeForm()
    {
        ...
        var settings = {};
        for (var k in arr) settings[ arr[k].name ] = arr[k].value;
        return settings;
    }
});
