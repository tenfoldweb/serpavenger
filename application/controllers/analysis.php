...
class Analysis extends CI_Controller {
	...
	public function index(){
		...
		$get_keyword_count = $this->model_analysis->count_keyword_by_user($session['user_id']);
		...
		$this->data['showresults']=$this->model_campaign->showresults($users_id);
		$this->data['totalcntshowresults']=$this->model_campaign->totalcntshowresults($users_id);
	 ...
	 public function showcontent()
   {
       ...
       $rid= $_POST['rid'];
        if($id == 1 || $id == '1'){
			...
			$session = $this->session->userdata('user_data');
			$users_id = $session['user_id'];
            $showresults = $this->data['showresults']=$this->model_campaign->showresults($users_id);
  ...
  $dta=$this->model_analysis->showcontentdata($id);
