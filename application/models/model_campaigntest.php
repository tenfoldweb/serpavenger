...
class Model_campaign extends CI_Model{
	...
	$sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_TEST . " WHERE campaign_title = '".$campaign_title."' AND users_id = '".$users_id."'";
	...
	$rec	= false;
	$sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGN_MASTER_TEST . " WHERE users_id = '".$users_id."' AND campaign_status = 'Active'";
	$query	= $this->db->query($sql);
	if($query->num_rows() > 0){
		...
		for($i=0; $i<count($rec); $i++){
		    $sql	= '';
		    $query	= '';
		    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_TEST . " WHERE c_id = '".$rec[$i]['campaign_id']."'";
		    $query	= $this->db->query($sql);
		    if($query->num_rows() > 0){
			...
			if(is_array($rec2) && count($rec2) > 0){
				...
				$sql3 = "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."'";
				$query3	= $this->db->query($sql3);
				$rec[$i]['campaigns'][$j]['total_kw']	= $query3->num_rows();
				
				// get google rank
				$sqlRank	= "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added = '".date("Y-m-d")."'";
				...
				$sqlRank2	= "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added = '".date("Y-m-d", time() - 60 * 60 * 24)."'";
				...
				$sqlRank3	= "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' ORDER BY date_added LIMIT 1";
				...
				$sqlRank4	= "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' ORDER BY rank DESC LIMIT 1";
				...
				$sqlRankTrend	= "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added BETWEEN '".date("Y-m-d", strtotime('-2 weeks'))."' AND '".date("Y-m-d")."'";
				...
				// get yahoo rank
				$sqlRank	= "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added = '".date("Y-m-d")."'";
				$queryRank	= $this->db->query($sqlRank);
				if($queryRank->num_rows() > 0){
				    $recRank	= $queryRank->row_array();
				...
				$sqlRank2	= "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added = '".date("Y-m-d", time() - 60 * 60 * 24)."'";
				...
				$sqlRank3	= "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' ORDER BY date_added LIMIT 1";
				$queryRank3	= $this->db->query($sqlRank3);
				if($queryRank3->num_rows() > 0){
				    $recRank3	= $queryRank3->row_array();
				...
				// get yahoo best rank
				$sqlRank4	= "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' ORDER BY rank DESC LIMIT 1";
				$queryRank4	= $this->db->query($sqlRank3);
				if($queryRank4->num_rows() > 0){
				    $recRank4	= $queryRank4->row_array();
				...
				$sqlRankTrend	= "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added BETWEEN '".date("Y-m-d", strtotime('-2 weeks'))."' AND '".date("Y-m-d")."'";
				$queryRankTrend = $this->db->query($sqlRankTrend);
				if($queryRankTrend->num_rows() > 0){
				    $recRanktrend = $queryRankTrend->result_array();
				    if(is_array($recRanktrend) && count($recRanktrend) > 0){
				...
				// get bing rank
				$sqlRank	= "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added = '".date("Y-m-d")."'";
				$queryRank	= $this->db->query($sqlRank);
				if($queryRank->num_rows() > 0){
				    $recRank	= $queryRank->row_array();
				...
				$sqlRank2	= "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added = '".date("Y-m-d", time() - 60 * 60 * 24)."'";
				$queryRank2	= $this->db->query($sqlRank2);
				if($queryRank2->num_rows() > 0){
				    $recRank2	= $queryRank2->row_array();
				...
				// get bing start rank
				$sqlRank3	= "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' ORDER BY date_added LIMIT 1";
				$queryRank3	= $this->db->query($sqlRank3);
				if($queryRank3->num_rows() > 0){
				    $recRank3	= $queryRank3->row_array();
				...
				// get bing best rank
				$sqlRank4	= "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' ORDER BY rank DESC LIMIT 1";
				$queryRank4	= $this->db->query($sqlRank3);
				if($queryRank4->num_rows() > 0){
				    $recRank4	= $queryRank4->row_array();
				...
				$sqlRankTrend	= "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$rec2[$j]['campaign_id']."' AND url = '".$rec2[$j]['campaign_main_page_url']."' AND date_added BETWEEN '".date("Y-m-d", strtotime('-2 weeks'))."' AND '".date("Y-m-d")."'";
				$queryRankTrend = $this->db->query($sqlRankTrend);
				if($queryRankTrend->num_rows() > 0){
				    $recRanktrend = $queryRankTrend->result_array();
				    if(is_array($recRanktrend) && count($recRanktrend) > 0){
		    ...
		    $sql	= '';
		    $query	= '';
		    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " AS CK, " . TABLE_USERS_CAMPAIGNS_TEST . " AS UC WHERE CK.campaign_id = UC.campaign_id AND UC.c_id = '".$rec[$i]['campaign_id']."'";
		    $query	= $this->db->query($sql);
...
//	if($cid > 0){
//	    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGN_MASTER_TEST . " WHERE users_id = '".$users_id."' AND campaign_status = 'Active' AND campaign_id = '".$cid."'";
//	}else{
//	    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGN_MASTER_TEST . " WHERE users_id = '".$users_id."' AND campaign_status = 'Active' LIMIT 3";
//	}
//	
//	$query	= $this->db->query($sql);
//	if($query->num_rows() > 0){
...
//		    $sql	= '';
//		    $query	= '';
//		    $sql	= "SELECT CK.keyword, CK.keyword_id, CK.campaign_id, UC.campaign_main_page_url FROM " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " AS CK, " . TABLE_USERS_CAMPAIGNS_TEST . " AS UC WHERE CK.campaign_id = UC.campaign_id AND UC.c_id = '".$rec[$i]['campaign_id']."' AND CK.keyword_type='M'";
//		    $query	= $this->db->query($sql);
...
//			    $sql = '';
//			    $query = '';
//			   echo $sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE url = '".$result[$j]['campaign_main_page_url']."' AND date_added BETWEEN '".date("Y-m-d", strtotime('-2  weeks'))."' AND '".date("Y-m-d")."'";
//			    $query = $this->db->query($sql);
//			    if($query->num_rows() > 0){
//				$rec2 = $query->result_array();
//				$return['gogole'] = $rec2;
...
//			    $sql = '';
//			    $query = '';
//			    $sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE url = '".$result[$j]['campaign_main_page_url']."' AND date_added BETWEEN '".date("Y-m-d", strtotime('-2  weeks'))."' AND '".date("Y-m-d")."'";
//			    $query = $this->db->query($sql);
//			    if($query->num_rows() > 0){
//				$rec2 = $query->result_array();
//				$return['yahoo'] = $rec2;
...
//			    $sql = '';
//			    $query = '';
//			    $sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE url = '".$result[$j]['campaign_main_page_url']."' AND date_added BETWEEN '".date("Y-m-d", strtotime('-2  weeks'))."' AND '".date("Y-m-d")."'";
//			    $query = $this->db->query($sql);
//			    if($query->num_rows() > 0){
//				$rec2 = $query->result_array();
//				$return['bing'] = $rec2;
...
//    }
	...
	if($query->num_rows() > 0){
		...
		for($i=0; $i<count($rec); $i++){
		    $sql	= '';
		    $query	= '';
		    $sql	= "SELECT CK.keyword, CK.keyword_id, CK.campaign_id FROM " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " AS CK, " . TABLE_USERS_CAMPAIGNS_TEST . " AS UC WHERE CK.campaign_id = UC.campaign_id AND UC.c_id = '".$rec[$i]['campaign_id']."' AND CK.keyword_type='M'";
		    $query	= $this->db->query($sql);
		    $result = $query->result_array();
		    if(is_array($result) && count($result) > 0){
			for($j=0; $j<count($result); $j++){
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' AND date_added = '".date("Y-m-d")."'";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' ORDER BY date_added ASC LIMIT 1";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' ORDER BY rank ASC LIMIT 1";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' AND date_added = '".date("Y-m-d", time() - 60 * 60 * 24)."'";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' AND date_added = '".date("Y-m-d")."'";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' ORDER BY date_added ASC LIMIT 1";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' ORDER BY rank ASC LIMIT 1";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' AND date_added = '".date("Y-m-d", time() - 60 * 60 * 24)."'";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' AND date_added = '".date("Y-m-d")."'";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' ORDER BY date_added ASC LIMIT 1";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' ORDER BY rank ASC LIMIT 1";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
			    ...
			    $sql	= '';
			    $query	= '';
			    $sql	= 'SELECT * FROM ' . TABLE_BING_CRAWL_DATA_TEST . " WHERE campaign_id = '".$result[$j]['campaign_id']."' AND keyword = '".$result[$j]['keyword']."' AND date_added = '".date("Y-m-d", time() - 60 * 60 * 24)."'";
			    $query	= $this->db->query($sql);
			    if($query->num_rows() > 0){
				$rec2 = $query->row_array();
	...
	$rec	= false;
	$sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGN_MASTER_TEST . " WHERE users_id = '".$users_id."' AND campaign_status = 'Active' group by users_id";
	$query	= $this->db->query($sql);
	if($query->num_rows() > 0){
	    $rec	= $query->result_array();
	    if(is_array($rec) && count($rec) > 0){
		for($i=0; $i<count($rec); $i++){
		    $sql	= '';
		    $query	= '';
		    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " AS CK, " . TABLE_USERS_CAMPAIGNS_TEST . " AS UC WHERE CK.campaign_id = UC.campaign_id AND UC.c_id = '".$rec[$i]['campaign_id']."' GROUP BY keyword";
		    $query	= $this->db->query($sql);
		    if($query->num_rows() > 0){
	...
	if($query->num_rows() > 0){
	   // pr($query->result_array());
	    foreach($query->result_array() as $index=>$data){
		    ...
		    $sql	= '';
		    $query	= '';
		    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " AS CK, " . TABLE_USERS_CAMPAIGNS_TEST . " AS UC WHERE CK.campaign_id = UC.campaign_id AND UC.c_id = '".$data['campaign_id']."'";
		    $query	= $this->db->query($sql);
	...
	if($query->num_rows() > 0){
		...
		for($i=0; $i<count($rec); $i++){
		    ...
		    $sql	= '';
		    $query	= '';
		    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_TEST . " WHERE c_id = '".$rec[$i]['campaign_id']."' AND campaign_site_type = 1";
		    $query	= $this->db->query($sql);
		    $total_money_sites	= $total_money_sites+$query->num_rows();
		    
		    $sql	= '';
		    $query	= '';
		    $sql	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_TEST . " WHERE c_id = '".$rec[$i]['campaign_id']."' AND campaign_site_type = 2";
		    $query	= $this->db->query($sql);
	...
	$sql	= "INSERT INTO " . TABLE_USERS_CAMPAIGNS_TEST . " SET
		  users_id			= '".$users_id."',
		  c_id				= '".$c_id."',
	...
	$sql= '';
	$sql	= "INSERT INTO " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " SET campaign_id = '".$capmaign_id."', users_id = '".$users_id."', keyword = '".$campaign_main_keyword."', keyword_type = 'M', status = 'Active', date_added = NOW()";
	$this->db->query($sql);
	...
	if(!empty($campaign_secondary_keyword)){	    
	    $sql= '';
	    $sql	= "INSERT INTO " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " SET campaign_id = '".$capmaign_id."', users_id = '".$users_id."', keyword = '".$campaign_secondary_keyword."', keyword_type = 'S', status = 'Active', date_added = NOW()";
	    $this->db->query($sql);  
	}
	...
	if(is_array($data) && count($data) > 0){
	    ...
	    if(!empty($updateStr)){
		$sql	= "UPDATE " . TABLE_USERS_CAMPAIGNS_TEST . " SET " . $updateStr . " date_modified = NOW() WHERE campaign_id = '".$campaign_id."'";
		$this->db->query($sql);
	    }
	...
	if($cid > 0){
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY rank LIMIT 0, " . $limit;
	    }else{
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY rank";
	    }
	    
	}else{
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' ORDER BY rank LIMIT 0, " . $limit;
	    }else{
		 $sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' ORDER BY rank";
	...
	if($cid > 0){
		...
		FROM ". TABLE_GOOGLE_CRAWL_DATA_TEST . "
		WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' AND rank <= ".$limit." AND campaign_id = '".$cid."'
		ORDER BY date_added, rank
	      ) ranked";
	    //$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' AND campaign_id = '".$cid."' ORDER BY rank LIMIT 0, " . $limit;
	}else{
	    //$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' ORDER BY rank LIMIT 0, " . $limit;
	    $sql = " SELECT url, rank, date_added
	    FROM
	      (SELECT url, rank, date_added, 
			   @crank := IF(@cdate_added = date_added, @crank + 1, 1) AS crank,
	...
	if($cid > 0){
	    ...
	    FROM
	      (SELECT url, rank, date_added, 
			   @crank := IF(@cdate_added = date_added, @crank + 1, 1) AS crank,
			   @cdate_added := date_added 
		FROM ". TABLE_YAHOO_CRAWL_DATA_TEST . "
		WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' AND rank <= ".$limit." AND campaign_id = '".$cid."'
		ORDER BY date_added, rank
	      ) ranked";	    
	}else{	    
	...
	//if($cid > 0){
	//    $sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' AND campaign_id = '".$cid."' ORDER BY rank LIMIT 0, " . $limit;
	//}else{
	//    $sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' ORDER BY rank LIMIT 0, " . $limit;
	//}
	...
	if($cid > 0){
	    ...
	    FROM
	      (SELECT url, rank, date_added, 
			   @crank := IF(@cdate_added = date_added, @crank + 1, 1) AS crank,
			   @cdate_added := date_added 
		FROM ". TABLE_BING_CRAWL_DATA_TEST . "
		WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' AND rank <= ".$limit." AND campaign_id = '".$cid."'
		ORDER BY date_added, rank
	      ) ranked";	    
	}else{	    
	...
	//if($cid > 0){	    
	//    $sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' AND campaign_id = '".$cid."' ORDER BY rank LIMIT 0, " . $limit;
	//}else{
	//    $sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' ORDER BY rank LIMIT 0, " . $limit;
	//}
	...
	if($cid > 0){
	    ...
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY rank LIMIT 0, " . $limit;
	    }else{
		$sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY rank";
	    }
	    ...
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' ORDER BY rank LIMIT 0, " . $limit;
	    }else{
		$sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' ORDER BY rank";
	    }
	...
	if($cid > 0){
	    ...
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY rank LIMIT 0, " . $limit;
	    }else{
		$sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY rank";
	    }
	    ...
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' ORDER BY rank LIMIT 0, " . $limit;
	    }else{
		$sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA_TEST . " WHERE date_added = '".$currDate."' ORDER BY rank";
	    }
	...
	$rec = false;
	$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA_TEST . " WHERE url = '".$campaign['campaign_main_page_url']."' AND date_added = '".date("Y-m-d")."'";
	$query = $this->db->query($sql);
	if($query->num_rows() > 0){
	    $rec = $query->row_array();
	}
	...
	if($query->num_rows() > 0){
		...
		for($i=0; $i<count($rec); $i++){
		    $sql	= '';
		    $query	= '';
		    $sql2	= "SELECT * FROM " . TABLE_USERS_CAMPAIGNS_KEYWORD_TEST . " AS CK, " . TABLE_USERS_CAMPAIGNS_TEST . " AS UC WHERE CK.campaign_id = UC.campaign_id AND UC.c_id = '".$rec[$i]['campaign_id']."' AND campaign_murl_domain <> '' GROUP BY campaign_murl_domain";
		    //echo "test2".$sql2;
...
WHERE `a`.`users_id` = b.users_id";
	...
	public function additionalkeywords($users_id)
		...
		public function additionalkeywordsloop($users_id)
		{
	   $sql = "SELECT keyword FROM  `serp_users_campaign_keywords` WHERE users_id = '".$users_id."' AND keyword_type =  'A' ORDER BY keyword DESC";
       $query = $this->db->query($sql);
					if($query->num_rows() > 0){
					    $rec = $query->result_array();
					}
