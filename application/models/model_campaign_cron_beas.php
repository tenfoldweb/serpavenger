...
class Model_campaign_cron_beas extends CI_Model{
	...
	if($cid > 0){
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY id LIMIT 0, " . $limit;
	    }else{
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA . " WHERE date_added = '".$currDate."' AND campaign_id = '".$cid."' ORDER BY id";
	    }
	    
	}else{
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA . " WHERE date_added = '".$currDate."' ORDER BY id " . $limit;
	    }else{
		 $sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA . " WHERE date_added = '".$currDate."' ORDER BY id";
    ...
    public function getGoogleDataForCampaignForRange($cid, $fromDate, $toDate, $limit){
	$rec = false;	
	if($cid > 0){
	    if(!empty($limit)){
		...
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."' AND campaign_id = '".$cid."' ORDER BY rank";
	    }
		...
		$sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."'  ORDER BY rank LIMIT 0, " . $limit;
		 ...
		 $sql = "SELECT * FROM " . TABLE_GOOGLE_CRAWL_DATA . " WHERE date_added BETWEEN '".$fromDate."' AND '".$toDate."'  ORDER BY rank";
	...
	if($cid > 0){
	    ...
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_YAHOO_CRAWL_DATA . " WHERE date_added = '".$currDate."' ORDER BY rank " . $limit;
	    }else{
	...
	if($cid > 0){
	    ...
	    if(!empty($limit)){
		$sql = "SELECT * FROM " . TABLE_BING_CRAWL_DATA . " WHERE date_added = '".$currDate."' ORDER BY rank " . $limit;
	    }else{
