                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body popupbody">
                            ...
                            <div class="existing-networks">
                                <p><img src="images/domain-icon2.png" alt=""> Assign Domains to Network</p>
                                <!-- choose-domain -->
                                <!--div class="choose-domain">
                                	<p class="listhead">Choose Domain(s)</p>
                                    <ul class="select-domain">
                                    	<li>
                                        	<input type="checkbox" class="css-checkbox" id="xyz" checked="checked">
                            				<label for="xyz" name="checkbox1_lbl" class="label-chkbx lite-gray-check">xyz.com</label>
                                        </li>
                                        <li>
                                        	<input type="checkbox" class="css-checkbox" id="msn" checked="checked">
                            				<label for="msn" name="checkbox1_lbl" class="label-chkbx lite-gray-check">in.msn.com</label>
                                        </li>
                                        <li>
                                        	<input type="checkbox" class="css-checkbox" id="youtube-d" checked="checked">
                            				<label for="youtube-d" name="checkbox1_lbl" class="label-chkbx lite-gray-check">youtube.com</label>
                                        </li>
                                        <li>
                                        	<input type="checkbox" class="css-checkbox" id="rediff-d" checked="checked">
                            				<label for="rediff-d" name="checkbox1_lbl" class="label-chkbx lite-gray-check">rediff.com</label>
                                        </li>
                                        <li>
                                        	<input type="checkbox" class="css-checkbox" id="amazon-d" checked="checked">
                            				<label for="amazon-d" name="checkbox1_lbl" class="label-chkbx lite-gray-check">amazon.com</label>
                                        </li>
                                        <li>
                                        	<input type="checkbox" class="css-checkbox" id="prihodnost-d" checked="checked">
                            				<label for="prihodnost-d" name="checkbox1_lbl" class="label-chkbx lite-gray-check">prihodnost.org</label>
                                        </li>
                                        <li>
                                        	<input type="checkbox" class="css-checkbox" id="facebook-d2" checked="checked">
                            				<label for="facebook-d2" name="checkbox1_lbl" class="label-chkbx lite-gray-check">facebook.com</label>
                                        </li>
                                  </ul>
                              ...
                              <!--div class="choose-network">
                                    ...
                                    <ul class="select-domain">
                                    	<li>
                                            <input type="radio" class="css-checkbox" id="uncategorized2" name="default-network">
                                            <label class="css-label radGroup1" for="uncategorized2">Uncategorized</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="gprn" name="default-network">
                                            <label class="css-label radGroup1" for="gprn">General PR Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="lcc" name="default-network">
                                            <label class="css-label radGroup1" for="lcc">Local California Clients</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="bon" name="default-network">
                                            <label class="css-label radGroup1" for="bon">Bing ONLY Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="dln" name="default-network">
                                            <label class="css-label radGroup1" for="dln">Denver Lock Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="hprn" name="default-network">
                                            <label class="css-label radGroup1" for="hprn">5+ High PR Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="agednet" name="default-network">
                                            <label class="css-label radGroup1" for="agednet">Aged Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="indexer-network" name="default-network">
                                            <label class="css-label radGroup1" for="indexer-network">Indexer Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="rwn" name="default-network">
                                            <label class="css-label radGroup1" for="rwn">Radio Works Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="test-net" name="default-network">
                                            <label class="css-label radGroup1" for="test-net">Test Network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="rjl" name="default-network">
                                            <label class="css-label radGroup1" for="rjl">Randy Jones Locker</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="test-net2" name="default-network">
                                            <label class="css-label radGroup1" for="test-net2">test network</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="css-checkbox" id="kristin-net" name="default-network">
                                            <label class="css-label radGroup1" for="kristin-net">Kristin's Network</label>
                                        </li>
                                  </ul>
