...
<script type="text/javascript" src="<?php echo FRONT_JS_PATH;?>analysis_demo.js"></script>
     ...
     <div class="submitter">
			...
			<option value="bing">Bing</option>
                ...
                <div class="analysis_toppanel clear">
                    ...
                    <div class="middlebox">
                    	<div class="content_heading clearfix">
                        <h2>Comparison: <label id="search_url"></label></h2>
			...
			<div class="comparisonSec">
		         <div id="contain-analysis-comparison">
				 <div class="comparisonSecTop clearfix">
                     <div class="compLt">
		      
		      <img id="comparision_image" src="<?php if(isset($single_campaign))  echo FRONT_SITE_THUMB_URL . $single_campaign['campaign_murl_thumb'];?>" alt=""/></div>
                        <div class="compRt">
