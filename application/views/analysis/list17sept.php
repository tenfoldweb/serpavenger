	...
	if($('#keyword_no').val() >= 5)
		{
		   ...
		   $.post("<?php echo base_url() ?>index.php/analysis/add_user_permissions", {name:permission_name, cost:total_cost}, function(data){
...
<?php break; } ?>
 ...
 <div id="ajaxresult1"></div>  <!-- <div id="ajaxresult">  -->
