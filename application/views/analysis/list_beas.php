...
<script type="text/javascript" src="<?php echo FRONT_JS_PATH;?>analysis_beas.js"></script>
...
<!--<section class="mainContainerSec">-->
  ...
  <tr>
    ...
    <td><p><a href="javascript:void()"  id="new_site_snape_shot"  class="snap_shot_link">News Sites</label></a></p></td>
