<script>
	   var image_path = '<?php echo FRONT_SITE_THUMB_URL;?>';
</script>
...
<!--<section class="mainContainerSec">-->
     <div class="submitter">
				<?php //pr($campagin_keyword_list, 0);?>
			...
			<option value="bing">Bing</option>
                    ...
                    <div class="clear"></div>
		    <!--<input type="text" name="search_keyword" id="search_keyword" value="" placeholder="Enter your keyword">
		    <input type="text" name="search_url" id="search_url" value="" placeholder="Enter your URL">
		    <input type="button" name="btn-search" id="btn-search" value="Go">-->
                </div>
                <div class="analysis_toppanel clear">
                	<div class="leftbox">
                    	<div class="content_heading clearfix">
                        <h2>SERP Meter <span id="today_heading_meter"></span>%</h2>
                        <div class="help"><img src="<?php echo FRONT_IMAGE_PATH;?>setup2.png" alt=""></div>
                        </div>
                        
                        <div class="metter"><img id="ranking_meter" src="<?php echo FRONT_IMAGE_PATH;?>analysis_img1.jpg" alt=""></div>
                        <div class="textArea">
                        <h3><span>Today:  <label id="today_meter"></label>%</span>Yesterday: <label id="yesterday_meter"></label>%</h3>
                        <h3>Week:  <label id="week_meter"></label>% Month: <label id="month_meter"></label>%</h3>
                        </div>
                    </div>
                    
                    <div class="middlebox">
                    	<div class="content_heading clearfix">
                        <h2>Comparison: <span id="search_url"></span></h2>
			<input type="hidden" value="<?php if(isset($single_campaign)) echo $single_campaign['keyword'];?>" id="keyword_value">
                        <div class="help"><img src="<?php echo FRONT_IMAGE_PATH;?>setup2.png" alt=""></div>
                        </div>
			...
			<div class="comparisonSec">
		           ...
		           <div class="compLt">
			   		     ...
			   		     <img id="comparision_image" src="<?php if(isset($single_campaign))  echo FRONT_SITE_THUMB_URL . $single_campaign['campaign_murl_thumb'];?>" alt=""/>
		     </div>
                        <div class="compRt">
				...
				<div id="loader-analysis-comparison" align="center" style="display: none; min-height: 50px; margin-top:10px;"><img src="<?php echo FRONT_IMAGE_PATH;?>loader.gif" alt="Loading"></div>
                  </div>
			...
			<div id="loader-site-kw-ratio" align="center" style="display: none; min-height: 50px; margin-top:10px;"><img src="<?php echo FRONT_IMAGE_PATH;?>loader.gif" alt="Loading"></div>
                    ...
                    <div class="snapShotbox">
                      ...
                      <div id="loader-site-kw-optimization" align="center" style="display: none; min-height: 50px; margin-top:10px;"><img src="<?php echo FRONT_IMAGE_PATH;?>loader.gif" alt="Loading"></div>  
                    </div>
  ...
  <tr>
    <td><p><span>Show Data For:&nbsp;&nbsp;<a href="javascript:void()" id="top_ten_snape_shot" class="snap_shot_link">Top 10</a></span></p></td>
    <td><p><a href="javascript:void()"  id="top_three_snape_shot"  class="snap_shot_link">Top 3</a></p></td>
    <td><p><a href="javascript:void()"  id="new_site_snape_shot"  class="snap_shot_link">New Sites</label></a></p></td>
    <td><p><a href="javascript:void()"  id="recovery_snape_shot"  class="snap_shot_link">Recovered</a></p></td>
    <td><p><a href="javascript:void()"  id="aged_snape_shot"  class="snap_shot_link">Aged(1+Yr.)</a></p></td>
    <td><p><a href="javascript:void()"  id="long_term_snape_shot"  class="snap_shot_link">Long Term</a></p></td>
    <td width="20%">&nbsp;</td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td><p><a id="linkelement_parasite" href="javascript:void(0);">Recovery</a></p></td>
