...
<div class="submitter">
  <div class="sub_top rankings_dashboard">
    <div class="drop1">
      <select name="campaign_list" id="campaign_list">
        <option value="">Select From Campaigns...</option>
        <?php
    ...
    <div class="google"> <span> <img src="<?php echo FRONT_IMAGE_PATH;?>icon-gplus.jpg"  alt=""/></span>
  ...
  <div class="sub_midpanel clear">
      ...
      <div>
        <?php
					if($serp_meter_stat <= 0){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-0.gif" alt="0%">';
					}elseif($serp_meter_stat > 0 && $serp_meter_stat <= 10){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-10.gif" alt="10%">';
					}elseif($serp_meter_stat > 10 && $serp_meter_stat <= 20){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-20.gif" alt="20%">';
					}elseif($serp_meter_stat > 20 && $serp_meter_stat <= 30){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-30.gif" alt="30%">';
					}elseif($serp_meter_stat > 30 && $serp_meter_stat <= 40){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-40.gif" alt="40%">';
					}elseif($serp_meter_stat > 40 && $serp_meter_stat <= 50){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-50.gif" alt="50%">';
					}elseif($serp_meter_stat > 50 && $serp_meter_stat <= 60){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-60.gif" alt="60%">';
					}elseif($serp_meter_stat > 60 && $serp_meter_stat <= 70){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-70.gif" alt="70%">';
					}elseif($serp_meter_stat > 70 && $serp_meter_stat <= 80){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-80.gif" alt="80%">';
					}elseif($serp_meter_stat > 80 && $serp_meter_stat <= 90){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-90.gif" alt="90%">';
					}elseif($serp_meter_stat > 90 && $serp_meter_stat <= 100){
						echo '<img src="'.FRONT_IMAGE_PATH.'meter-100.gif" alt="100%">';
					}
					?>
        <!--<img src="<?php echo FRONT_IMAGE_PATH;?>meter-0.gif" alt="0%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-10.gif" alt="10%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-20.gif" alt="20%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-30.gif" alt="30%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-40.gif" alt="40%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-50.gif" alt="50%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-60.gif" alt="60%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-70.gif" alt="70%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-80.gif" alt="80%">
					<img src="<?php echo FRONT_IMAGE_PATH;?>meter-90.gif" alt="90%">
					<img class="active" src="<?php echo FRONT_IMAGE_PATH;?>meter-100.gif" alt="100%">--> 
      </div>
    </div>
    <div class="rankings_part2">
      ...
      <div class="mapTopNo">
        <div class="mapTopDiv"> <span class="topNo">Top3</span>
          <div class="mapcave">
            <div class="mapcaveIn">
              <p><span class="mapcaveSpan"><img src="<?php echo FRONT_IMAGE_PATH;?>small-img1.jpg"  alt="carve-img"/><?php echo $moneysite_count_top3;?></span><span class="mapcaveSpan rightIn">
                <?php if($moneysite_count_top3_diff >= 0){echo '+' . $moneysite_count_top3_diff;}else{echo '-' . $moneysite_count_top3_diff;}?>
                <?php if($moneysite_count_top3_diff >= 0){?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>green-icon.jpg"  alt="carve-img"/>
                <?php }else{?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>red-icon.jpg"  alt="carve-img"/>
                <?php } ?>
                </span></p>
            ...
            <div class="mapcaveIn mapcaveInRight">
              <p><span class="mapcaveSpan"><img src="<?php echo FRONT_IMAGE_PATH;?>small-img2.jpg"  alt="carve-img"/><?php echo $parasite_count_top3?></span><span class="mapcaveSpan rightIn">
                <?php if($parasite_count_top3_diff >= 0){echo '+' . $parasite_count_top3_diff;}else{echo '-' . $parasite_count_top3_diff;}?>
                <?php if($parasite_count_top3_diff >= 0){?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>green-icon.jpg"  alt="carve-img"/>
                <?php }else{?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>red-icon.jpg"  alt="carve-img"/>
                <?php } ?>
        ...
        <div class="mapTopDiv"> <span class="topNo">Top10</span>
          <div class="mapcave">
            <div class="mapcaveIn">
              <p><span class="mapcaveSpan"><img src="<?php echo FRONT_IMAGE_PATH;?>small-img3.jpg"  alt="carve-img"/><?php echo $moneysite_count_top10;?></span><span class="mapcaveSpan rightIn redcolor">
                <?php if($moneysite_count_top10_diff >= 0){echo '+' . $moneysite_count_top10_diff;}else{echo '-' . $moneysite_count_top10_diff;}?>
                <?php if($moneysite_count_top10_diff >= 0){?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>green-icon.jpg"  alt="carve-img"/>
                <?php }else{?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>red-icon.jpg"  alt="carve-img"/>
                <?php } ?>
            ...
            <div class="mapcaveIn mapcaveInRight">
              <p><span class="mapcaveSpan"><img src="<?php echo FRONT_IMAGE_PATH;?>small-img4.jpg"  alt="carve-img"/><?php echo $parasite_count_top10;?></span><span class="mapcaveSpan rightIn">
                <?php if($parasite_count_top10_diff >= 0){echo '+' . $parasite_count_top10_diff;}else{echo '-' . $parasite_count_top10_diff;}?>
                <?php if($parasite_count_top10_diff >= 0){?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>green-icon.jpg"  alt="carve-img"/>
                <?php }else{?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>red-icon.jpg"  alt="carve-img"/>
                <?php } ?>
        ...
        <div class="mapTopDiv"> <span class="topNo">Top20</span>
          <div class="mapcave">
            <div class="mapcaveIn">
              <p><span class="mapcaveSpan"><img src="<?php echo FRONT_IMAGE_PATH;?>small-img5.jpg"  alt="carve-img"/><?php echo $moneysite_count_top20;?></span><span class="mapcaveSpan rightIn">
                <?php if($moneysite_count_top20_diff >= 0){echo '+' . $moneysite_count_top20_diff;}else{echo '-' . $moneysite_count_top20_diff;}?>
                <?php if($moneysite_count_top20_diff >= 0){?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>green-icon.jpg"  alt="carve-img"/>
                <?php }else{?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>red-icon.jpg"  alt="carve-img"/>
                <?php } ?>
            ...
            <div class="mapcaveIn mapcaveInRight">
              <p><span class="mapcaveSpan"><img src="<?php echo FRONT_IMAGE_PATH;?>small-img6.jpg"  alt="carve-img"/><?php echo $parasite_count_top20;?></span><span class="mapcaveSpan rightIn redcolor">
                <?php if($parasite_count_top20_diff >= 0){echo '+' . $parasite_count_top20_diff;}else{echo '-' . $parasite_count_top20_diff;}?>
                <?php if($parasite_count_top20_diff >= 0){?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>green-icon.jpg"  alt="carve-img"/>
                <?php }else{?>
                <img src="<?php echo FRONT_IMAGE_PATH;?>red-icon.jpg"  alt="carve-img"/>
                <?php } ?>
    ...
    <div class="rankings_part3">
      ...
      <div class="rankTrack">
        <div class="rankTrackIn"> <span class="rankTop">Top 10</span>
        ...
        <div class="rankTrackIn"> <span class="rankTop">Top 20</span>
          <div class="rankTrackRight">
  ...
  <div class="active_com clear">
    <div class="active_block1"> <span><img src="<?php echo FRONT_IMAGE_PATH;?>pic5.png"  alt=""/></span>
      <div class="right_text"> <?php echo $campaign_detail['active_campaign'];?> Active Campaigns <span class="sm_text"><a href="<?php echo FRONT_URL;?>campaign/">+ Add Campaign</a></span> </div>
    </div>
    <div class="active_block1"> <span><img src="<?php echo FRONT_IMAGE_PATH;?>img34.jpg"  alt=""/></span>
      <div class="right_text"> <?php echo $campaign_detail['total_kw'];?> Keywords <span class="sm_text"><a href="<?php echo FRONT_URL;?>campaign/">+ Add Campaign</a></span> </div>
    </div>
    <div class="active_block1"> <span><img src="<?php echo FRONT_IMAGE_PATH;?>table-icon2.jpg"  alt=""/></span>
      <div class="right_text"> <?php echo $campaign_detail['total_money_sites'];?> Money/Client Sites <span class="sm_text"><a href="<?php echo FRONT_URL;?>campaign/">+ Add More</a></span> </div>
    </div>
    <div class="active_block1"> <span><img src="<?php echo FRONT_IMAGE_PATH;?>table-icon3.jpg"  alt=""/></span>
      <div class="right_text"> <?php echo $campaign_detail['total_para_sites'];?> Parasite Pages <span class="sm_text"><a href="<?php echo FRONT_URL;?>campaign/">+ Add More</a></span> </div>
    </div>
    <div class="active_block1 active_block1_last"> <span><img src="<?php echo FRONT_IMAGE_PATH;?>img35.jpg"  alt=""/></span>
      <div class="right_text"> <?php echo $count_seo_ranking_test;?> SEO / Ranking Tests <span class="sm_text"><a href="<?php echo FRONT_URL;?>seoranking/">+ Add More</a></span> </div>
      <img src="<?php echo FRONT_IMAGE_PATH;?>img2.png"  alt=""/> </div>
    <div class="clear"></div>
  </div>
  <div class="sub_buttom">
    <div class="content_titel clearfix">
      <h2>Ranking Chart</h2>
      <span class="help"><img src="<?php echo FRONT_IMAGE_PATH;?>img2.png" /></span>
      <div class=" rating_right">
        <div class="google"> <span> <img alt="" src="<?php echo FRONT_IMAGE_PATH;?>icon-gplus.jpg"></span>
          <div class="drop1 google">
    ...
    <div class="rating_inner clearfix" style="position:relative; padding-bottom:0px">
      <div class="rating_left rating_left_rank" style="height:400px; width:950px" id="container"> </div>
      <div id="tooltip" class="thetooltip">
        <p id="tooltiptext" style="margin:0">default</p>
      </div>
      <div class="rating_left rating_left_rank" style="height:400px; width:950px" id="container2"> </div>
      <!--<div class=" rating_right">			
                            <div class="google">
  ...
  <div class="sub_buttom rankings_keyword">
    <div class="content_titel clearfix">
      <h2>Rankings by Keyword</h2>
      <div class="side_pl"> <a href="<?php echo FRONT_URL;?>campaign/" class="campaign_btm">+ Add Campaign</a> <span class="help"><img src="<?php echo FRONT_IMAGE_PATH;?>img2.png" /></span> </div>
    </div>
    <div class="rating_inner">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td><?php echo $percent_google_rank;?>%
            <?php if($percent_google_rank > 0){?>
            <img src="<?php echo FRONT_IMAGE_PATH;?>red_ar.png"  alt=""/>
            <?php }else{?>
            <img src="<?php echo FRONT_IMAGE_PATH;?>green_ar.png"  alt=""/>
            <?php } ?></td>
          ...
          <td><?php echo $percent_bing_rank;?>%
            <?php if($percent_bing_rank > 0){?>
            <img src="<?php echo FRONT_IMAGE_PATH;?>red_ar.png"  alt=""/>
            <?php }else{?>
            <img src="<?php echo FRONT_IMAGE_PATH;?>green_ar.png"  alt=""/>
            <?php } ?></td>
          ...
          <td><?php echo $percent_yahoo_rank;?>%
            <?php if($percent_yahoo_rank > 0){?>
            <img src="<?php echo FRONT_IMAGE_PATH;?>red_ar.png"  alt=""/>
            <?php }else{?>
            <img src="<?php echo FRONT_IMAGE_PATH;?>green_ar.png"  alt=""/>
            <?php } ?></td>
