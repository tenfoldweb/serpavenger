...
<link rel="stylesheet" href="<?php echo FRONT_CSS_PATH;?>bootstrap-multiselect.css">
...
<script type="text/javascript" src="<?php echo FRONT_JS_PATH;?>bootstrap-multiselect.js"></script>
...
function set_ranking_permission(permission_cost, permission_name, frm_id)
{
	 $.post("<?php echo base_url() ?>index.php/ranking/add_user_permissions", {name:permission_name, cost:permission_cost}, function(data){
	...
	if($('#keyword_no').val() >= 5)
		{
		   ...
		   $.post("<?php echo base_url() ?>index.php/networkmanager/add_user_permissions", {name:permission_name, cost:total_cost}, function(data){
	                     ...
	                     $('input[name=return]').val("http://serpavenger.com/serp_avenger/ranking/?custom="+package_id+"&keyword="+new_keyword_no);
...
var form_data = {
 ...
 ajax : '1'
  ...
  $.ajax({
       ...
       async : false,
       data: form_data,
        url: '<?php echo base_url(); ?>index.php/ranking/getCDetailsKeywords/',       
  ...
  $("#trbg_"+d).css("background-color","rgb(230, 245, 245)");
}else{
    $(this).text("Show");
    $("#trbg_"+d).css("background-color","#FFFFFF");
   $('.togg'+d).css('display','none');
   $('.togg'+d).empty();
 }
//return false;
});
...
<!-- end on 20th august -->
<style type="text/css">
.rating-block li:first-child .lightblue{
	background:#7cb5ec
}
.rating-block li:last-child .lightblue{
	background:#90ed7d
}
.rating-block li:first-child+li .lightblue{
	background:#434348
}
li.kw_selected>p{
	color:#ccc;
}
li.kw_selected p>.lightblue{
...
<?php require ('application/libraries/gChart.php');?>
  ...
  <div class="row" id="header">
    ...
    <div class="col-md-9 menusec right-col">
      <?php //print_r($session = $this->session->userdata('user_data'));
            ...
            //$string = read_file(FRONT_URL'.includes/header.php'); 
            //require ("http://serpavenger.com/serp_avenger/includes/header.php");
            //include_once(FRONT_URL.'includes/header.php'); ?>
...
<optgroup label="<?php echo stripslashes($campaign_domain_list[$i]['campaign_title']);?>">
                  ...
                  <?php } /*?><option value="<?php echo stripslashes($campaign_list[$i]['campaign_id']);?>" <?php if($cid == $campaign_list[$i]['campaign_id']){echo 'selected';}?>><?php echo stripslashes($campaign_list[$i]['campaign_title']);?></option><?php */?>
		...
		if($cid == $campaign_domain_list[$i]['campaign_id']){ 
				 ...
				 echo 'selected';}?>><?php echo '----' . stripslashes($campaign_domain_list[$i]['campaign_main_page_url']);?></option>
...
?>
            ...
            <div class="filterby choose-campaign">
            <span>Crawled By:</span> 
            <div class="dropdown">
      ...
      <div class="row"> 
        ...
        <div class="col-md-5 col-md-5-1"> 
          ...
          <div class="serprank"> 
            ...
            <div class="imgholder"> <img src="<?php echo FRONT_IMAGE_PATH;?><?php echo $getdetailkeywordinfo->campaign_murl_thumb; ?>" alt=""> </div>
...
for($i=0; $i<count($selected_campaign_keyword_list); $i++){
	//if($selected_campaign_keyword_list[$i]['keyword_type']!='M' && $selected_campaign_keyword_list[$i]['keyword_type']!='S'){
?>
...
for($i=0; $i<count($selected_campaign_keyword_list); $i++){ ?>
                <li data-id="k<?php echo $selected_campaign_keyword_list[$i]['keyword_id']; ?>" data-type="<?php echo $selected_campaign_keyword_list[$i]['keyword_type']; ?>">
                	<p> <span class="lightblue"></span>
                    <?php echo stripslashes($selected_campaign_keyword_list[$i]['keyword']).' ('.$selected_campaign_keyword_list[$i]['keyword_type'].')'; ?>
                  	</p>
                ...
                ?>
                  ...
                  <p> <span class="lightblue"></span>
                    <?php 
                    echo $serpindex['keywords']; ?>
                    <span class="levelno"> <?php echo $serpindex['domain_word_count']; ?> </span> <span class="badge small-badge small-badgegreen  pull-right"><?php echo $serpindex['rank']; ?></span> </p>
                  <?php
                }
           */?>
                </li>
          ...
          <div class="serp-ta mtrranking-row-block">
              ...
              <div class="topno-row"> 
                ...
                <div class="stablock mgrR">
                  <ul>
                    ...
                    <li class="pull-right">
                      <p> <span class="sta-blue"></span> New <small class="green1"><?php echo $new_url_top10;?></small> </p>
                      <p> <span class="sta-blue"></span> Drop <small class="red1"><?php echo $drop_url_top10;?></small> </p>
                    </li>
                  </ul>
                </div>
                ...
                <div class="topno-row"> 
                  ...
                  <div class="stablock bdrbtm">
                    <ul>
                      ...
                      <li class="pull-right">
                        <p> <span class="sta-blue"></span> New <small class="green1"><?php echo $new_url_top20;?></small> </p>
                        <p> <span class="sta-blue"></span> Drop <small class="red1"><?php echo $drop_url_top20;?></small> </p>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="sta-graph pull-right">
              <div class="serp-meter mtrranking-row-block">
                <div class="metersecheader ">SERP Meter
                  <?php
//echo "serp_meter_stat".$serp_meter_stat='30';
             echo $serp_meter_stat?>
                  %</div>
...
?>
                <span class="serpmeter-canvas"><img src="<?php echo FRONT_IMAGE_PATH;?>serp-meter-graph.gif" class="img-responsive" align="center"  alt=""></span> </div>
            </div>
          </div>
        </div>
        <div class="col-md-2">
        ...
        <ul class="tools">
          <li><img src="<?php echo FRONT_IMAGE_PATH;?>KeywordsIcon.gif" width="16" height="16" alt=""> <span><?php echo $getcountkey; ?> Keyword <a data-toggle="modal" data-target="#addKeywords">+ Add Keywords</a> <a data-toggle="modal" data-target="#ManageKeywords">+ Manage Keywords</a></span> </li>
          <!-- More domains popup -->
          ...
          <?php
			 // Added by beas - For check if he is already added maximum keyword
			 if($get_keyword_count < $max_keyword_track){
          ...
          <div class="modal-body popupbody">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-condensed popuptbl table-responsive">
              <tr>
                <td><ul>
                    <li> <span class="add_text">Campaign</span>
...
?>
                          <option value="<?php echo $campaign_list[$i]['campaign'][$j]['keyword_id'];?>"><?php echo '----' . stripslashes($campaign_list[$i]['campaign'][$j]['keywords']);?></option>
                          <?php
}
}
}
...
?>
                    ...
                    <li> <span class="add_text">Site</span>
                      <div class="dropdown drop_right drpdrp"> <img alt="" src="<?php echo FRONT_IMAGE_PATH;?>Parasite.gif">
...
?>
              ...
              <tr>
                <td><ul>
                    <li> <span class="add_text">Serp Index</span>
                      <div class="drpright">
                        <div class="droptextd">
...
?>
                    ...
                    <li>
                      <div class="exact_url">
                        ...
                        <div class="radio_bnt_tt">
                          ...
                          <label class="css-label radGroup1" for="no_please" style="font-weight:600; font-size:12px;">No, Please lookfor any of my pages ranking<br>
                            <i>(Don't use this optionfor parasite pages!)</i></label>
                        </div>
                      </div>
                    </li>
                  </ul></td>
              ...
              <tr>
                <td><ul>
                    <li> <span class="add_text">+ Keywords</span>
                    ...
                    <li>
                      <div class="exact_url">
                        ...
                        <div class="orandbnt"> <span class="or">OR</span> <a data-target="#ManageKeywords" class="btn btn-default" type="button" data-toggle="modal">Manage Keywords</a> 
 ...
 // Added by beas
          ...
          Please upgrade for add more keyword. <br>
          <br>
          <form action="" id="" name="">
            Enter number of keyword you want to purchase&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" name="keyword_no" id="keyword_no">
            <br>
            (You must purchase a minimum of 5 keywords)
          </form>
          <br>
          <br>
          <?php
...
?>
          <form name="_xclick" id="add_keyword<?=$fcnt; ?>" action="https://sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
            ...
            <input type="hidden" name="item_name" value="<?=$row['package_name']; ?> - Add More Keywords">
            <!--<input type="hidden" name="amount">-->
            <input type="hidden" name="new_keyword_no">
          ...
          <br>
          <input type="button" name="submit" value="Upgrade <?php echo $row['package_name']." ($".$row['more_domain_adding_cost']." for each keyword)"; ?>"
 onClick="set_keyword_val('<?=$row['more_keyword_adding_cost_ranking']; ?>', <?=$row['package_id']; ?>, '<?=$row['package_name']; ?> - Add More Keywords', 'add_keyword<?=$fcnt; ?>')">
          <br>
          <?php 
...
?>
                      ...
                      <tr>
                        <td><span class="add_text">Serp Index</span>
                          <div class="drpright">
...
?>
                              <tr>
                                ...
                                <td><select  class="dropdown-select" name="keywordtype" id="keywordtype">
                                  ...
                                  <?php //echo $nodefirstdi['campaign_exact_url_track']; ?>
                                  <!--<img src="<?php //echo FRONT_IMAGE_PATH;?>gray-arrow.png">--></td>
                                <td><div class="checkbox12"> <a  onclick="return confirm('Are You sure?')" href="<?php echo base_url();?>index.php/ranking/keyworddelete/<?php echo $nodefirstdi['campaign_id'];?>">
...
?>
                          ...
                          <div class="orandbnt orbntSave"> <span class="or">OR</span> <a data-target="#addKeywords" class="btn btn-default"  data-toggle="modal">Add Keywords</a> 
...
<ul>
  ...
  <div class="inner-table rankingchart">
    ...
    <div class="panel-body-tbl">
      ...
      <div class="carveMapSec"> <div style="height:400px; width:100%" id="container"> </div>
            <div id="tooltip" class="thetooltip">
              <p id="tooltiptext" style="margin:0">default</p>
            </div>
			
            <div style="height:400px; width:950px" id="container2"> </div><?php /*?><img src="<?php echo FRONT_IMAGE_PATH;?>ranking-chart-img.gif" class="img-responsive" style="width:100%; height:220px" alt=""><?php */?> </div>
      <div class="clearfix"></div>
    </div>
  </div>
  ...
  <div class="inner-table rankingchart">
    ...
    <div class="panel-body-tbl-onpage">
      <div class="rbktoprow">
        <div class="pull-left srb"> <span>First choose a Campaign:</span>
          <div class="dropdown">
        ...
        <ul class="pull-right btns-group">
          <li>
            <button data-dismiss="modal" class="btn btn-default" onClick="window.location.href='<?php echo FRONT_URL;?>analysis'" type="button">Add Ranking Analysis</button>
          </li>
          <li>
            <button data-toggle="modal" class="btn btn-default" type="button" data-target="#startaseotest">Start a SEO Test</button>
          </li>
          <li>
            <button class="btn btn-primary" onClick="window.location.href='<?php echo FRONT_URL;?>campaign'" type="button">Add Campaign</button>
          </li>
      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table-bordered ranking-tbl" style="font-size:14px;">
        ...
        <?php //$this->load->model('model_ranking'); 
...
?>
        <tr id="ntr<?php echo $campaignlist[$j]['campaign_id'];?>">
          ...
          <td id="trbg_<?php echo $campaignlist[$j]['campaign_id'];?>"><?php echo stripslashes($campaignlist[$j]['total_kw']);?>
            <ul class="pull-right">
              ...
              <li><!--<a class="bluelink" onclick="show()" id ="show_content">Show</a>--> 
                <a href="#"  id="<?php echo $campaignlist[$j]['campaign_id'];?>" class="toggle3" title="<?php echo $campaignlist[$j]['campaign_id'];?>">Show</a> </li>
              <li>
                <div class="table-responsive toggle_box arrowpopup arrowdata zindexauto" id="toggle_box" style="display:none;"></div>
              </li>
            </ul></td>
        ...
        <tr class="togg<?php echo $campaignlist[$j]['campaign_id'];?>" id="toggle<?php echo $campaignlist[$j]['campaign_id'];?>" style="display:none; background-color: rgb(230, 245, 245);"> </tr>
        <script>
...
<form name="_xclick" id="rnk_permission<?=$fcnt; ?>" action="https://sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
  ...
  <input type="hidden" name="no_shipping" value="1">
  <input type="hidden" name="item_number">
  <input type="hidden" name="item_name" value="<?=$row['package_name']; ?> - Ranking Permission">
  <!--<input type="hidden" name="amount">-->
  <input type="hidden" name="a3" value="<?php echo $row['ranking_upgrade_cost']; ?>">
  <!--<input type="hidden" name="discount_rate">-->
  <input type="hidden" name="p3" value="1">
  <input type="hidden" name="t3" value="M">
  <input type="hidden" name="src" value="1">
  <input type="hidden" name="sra" value="1">
  <input type='hidden' name='rm' value="0">
  <input type="hidden" name="return" value="http://serpavenger.com/serp_avenger/ranking/?custom=<?=$row['package_id']; ?>">
  <input type="hidden" name="bn" value="PP-SubscriptionsBF:btn_subscribe_SM.gif:NonHostedGuest">
</form>
<br>
<input type="button" name="submit" value="Upgrade <?php echo $row['package_name']; ?> "
 onClick="set_ranking_permission('<?=$row['ranking_upgrade_cost']; ?>', '<?=$row['package_name']; ?> - Ranking Permission', 'rnk_permission<?=$fcnt; ?>')">
<br>
<?php $fcnt++; }} ?>
</div>
...
?>
            ...
            <tr>
              <td class="page_tst"><h2><span>1</span> What type of SEO test would you like to create?</h2>
                <ul>
                  <li>
                    ...
                    <br>
                    <span>Link building, or off site factors. </span>
                    </label>
                  </li>
                  <li>
                    ...
                    <br>
                    <span>Site optimization, or on site factors.</span>
                    </label>
                  </li>
                </ul>
                <div class="clearfix"></div>
                <div class="TitleofTest">
                  <p> <span class="add_text">Title of Test</span>
                  ...
                  <p> <span class="add_text">My Notes</span>
            ...
            <tr>
              <td class="date_pickr"><h2><span>2</span>Select a Start Date:</h2>
                ...
                <div class="add_color_shading"><!-- off page-->
                  <ul>
                    <li> <span class="add_text">Shading to chart:</span> </li>
                    <li>
                      <div class="radio_bnt_tt">
            ...
            <tr>
              <td class="keywordimp"><h2><span>3</span>Specify which keywords/pages are impacted:</h2>
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    <label for="selectkey" class="css-label radGroup1"> <span class="swkpr">Select Keywords that are impacted. </span></label>
                  </li>
                  <li>
                    <input id="selectpeg"  name="selectkeyne"  class="css-checkbox" type="radio"  value="selectpeg">
                    <label class="css-label radGroup1" for="selectpeg" name="checkbox1_lbl"><span class="swkpr">Select Pages that are impacted.</span></label>
                  </li>
                </ul></td>
            </tr>
            <tr>
              <td class="bnt_p_de"><!--button class="btn btn-primary" type="button">Create SEOTest<button-->
                <input type="hidden" name="action" value="Process">
                <input name="submit" type="submit" value="Create SEO Test" class="btn btn-primary" style="width:124px;"/>
                <button data-toggle="modal" class="btn btn-default" type="button" data-target="#startaseotest">Start a SEO Test</button>
                
                <!-- <button class="btn btn-default" type="button" data-dismiss="modal">Manage Tests</button> --></td>
            </tr>
          </table>
        </form>
      </div>
