...
function showCampiagn(str) {
  ...
  xmlhttp.open("GET","<?php echo site_url('index.php/ranking/getUsersCampaignKeywordList'); ?>?q="+str,true);
  xmlhttp.send();
}
    ...
    <div class="col-md-5 col-md-5-2 bdrRL">
        <div class="serp-ta mtrranking-row-block">
            ...
            <div class="stablock mgrR">
                 <ul>
                    <li id="tracking1" class="pull-left"><img src="<?php echo FRONT_IMAGE_PATH;?>sta-img.png" width="80" height="16" alt=""></li>
                    <li class="pull-right">
                        <p>
            ...
            <div class="stablock bdrbtm">
                 <ul>
                    <li id="tracking2" class="pull-left"><img src="<?php echo FRONT_IMAGE_PATH;?>sta-img.png" width="80" height="16" alt=""></li>
                    <li class="pull-right">
                        <p>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-condensed popuptbl table-responsive">
                    <tr>
                     ...
                     <li>	
                        <span class="add_text">Campaign</span>
                        <div class="dropdown drop_right">
                       <select class="dropdown-select" name="selectmanakeywords" id="selectmanakeywords" onchange="showCampiagn(this.value)">
             <?php
if(is_array($campaign_list) && count($campaign_list) > 0){
for($i=0; $i<count($campaign_list); $i++){
?>
...
?>  
                    ...
                    <li>
                        ...
                        <div class="dropdown drop_right drpdrp">
                        <img alt="" src="<?php echo FRONT_IMAGE_PATH;?>Parasite.gif">
                        <select class="dropdown-select" name="selectmanagekeysite" id="selectmanagekeysite" onchange="showSite(this.value)">
...
?>  
                           ...
                           <!--  <button class="btn btn-primary" type="button">Save Changes</button>  -->         <input class="btn btn-primary" type="submit" name="addkeyword" value="Save Changes" style="width: 104px;">                                                 
          ...
          <li><img src="<?php echo FRONT_IMAGE_PATH;?>SEOTestIcon.gif" width="16" height="14" alt=""> <span>15 Keyword <a data-target="#startaseotest" data-toggle="modal">+ Manage Tests</a><!-- <a data-toggle="modal" data-target="##">+ Manage Tests</a> --></span></li>
           <!-- More domains popup -->
