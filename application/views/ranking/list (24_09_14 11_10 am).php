...
<optgroup label="<?php echo stripslashes($campaign_list[$i]['campaign_title']);?>">
...
?>
                  <option value="<?php echo $campaign_list[$i]['campaign'][$j]['keyword_id'] . '-' . $campaign_list[$i]['campaign'][$j]['campaign_id'];?>" <?php if($cid == $campaign_list[$i]['campaign'][$j]['campaign_id']){echo 'selected';}?>><?php echo '----' . stripslashes($campaign_list[$i]['campaign'][$j]['keyword']);?></option>
                  <?php
		}
	}
	?>
        ...
        <div class="col-md-5 col-md-5-1"> 
          ...
          <div class="viewkeyword">
            ...
            <div class="fropfilter">
              <div class="dropdown drpwsty" style="width:100%">
