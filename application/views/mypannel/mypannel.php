    ...
    <div class="mypanel-tab-content">
        ...
        <div id="my-tab-content" class="tab-content mypanel-contant">
            <div class="tab-pane active" id="pannel-my-compagins">
               ...
               <!--  <div class="col-md-12 more-recent">
                ...
                <div class="filterblock-mypnl">
                    <div class="topbreadcrumbarea">
                        <ol class="breadcrumb topbreadcrumb">
                            <li><span id="campaigntest"><a href="<?php echo $campaignlistuser[0]['campaign_main_page_url'];?>" target="_blank"><?php echo $campaignlistuser[0]['campaign_main_page_url'];?></a></span></li>
                            <li id="campaign_secondary_keyword"><?php echo $campaignlistuser[0]['campaign_main_keyword'];?></li>
                            <li class="active" id="campaigntest1"><?php echo $campaignlistuser[0]['campaign_title'];?></li>
                        </ol>
                    </div>
                ...
                <div class="denever-locksmith">
                                   <div class="dlheader">
                                       <h2><span id="campaigntest2"><a href="<?php echo $campaignlistuser[0]['campaign_main_page_url'];?>" target="_blank"><?php echo $campaignlistuser[0]['campaign_title'];?></a></span></h2>
                       <!-- manage button -->
                  ...
                  <div class="dlbody">
                    ...
                    <div class="websiteinfo">
                        <div class="website-thumb">
                            <img id="campaign_murl_thumb" src="<?php echo base_url(); ?>images/screenshots/<?php echo $campaign_namedetail[0]->campaign_murl_thumb; ?>" width="200" height="150" alt=""/>
                         </div>
                ...
                <?php if($campaign_namedetail[0]->campaign_site_type='1') {  ?>
                    ...
                    <?php echo $campaign_namedetail[0]->campaign_murl_country_code; ?></option>
                         ...
                         <div class="website-link">
                             <span id="campaigntest3"><a href="<?php echo $campaignlistuser[0]['campaign_main_page_url'];?>" target="_blank"><?php echo $campaignlistuser[0]['campaign_main_page_url'];?></a></span>
                         </div>
                        <div class="clearfix"></div>
                    </div>
                   ...
                   <div class="dlthumb carousel-wrapper" id="campaignchieldthumb">
                       <ul class="carousel-inner clearfix">
                          <?php
             foreach($campaign_fullimagedet as $campaignfullimagedet) { ?>
                          <li  class="showSingle itemS" target="1">
                      ...
                      <div class="addmore-btn"><a href="">+ ADD MORE</a></div>
            ...
            <div class="dlbody more-recent pnlalltmb" id="divinner<?=$cnt;?>">
						 <div class="carousel-wrapper" id="products">
                                  <ul class="carousel-inner addmoresec clearfix">
                                    <li class="itemS"><img width="90" height="67" alt="" src="http://serpavenger.com/screenshot/results/<?php echo $campaignlistusernm['thumbailsize1']; ?>.jpg"></li>
                                   <!-- <li class="itemS"><img width="90" height="67" alt="" src="images/2.jpg"></li>-->
                                    <li class="itemS addmore-btn"><a href="">+ ADD MORE</a></li>
                                  </ul>
                                  <a href="#" class="carousel-left"></a> <a href="#" class="carousel-right"></a>
                             </div>
                        <div class="clearfix"></div>
                ...
                <div class="clearfix"></div>
				<?php for($i=0;$i<=count($campaignlistuser);$i++){ ?>
			<div class="denever-locksmith">
                <div class="dlheader">
				<span style="color:#fff;padding:10px;display:block;font-size:13px;font-weight:600;"><?php echo $campaignlistuser[$i]['campaign_title']; ?></span>
				</div>
			</div>
			 <div class="clearfix"></div>
			<?php } ?>
                 ...
                 <!-- Live visual snapshot-->
                    <div class="denever-locksmith lvshead-main">
                        <div class="dlheader lvshead">
                            <ul>
                                <li><a href="#" class="active" style="color:#fff;">Live Visual Snapshot</a></li>
                                <li><a href="#" id="testntwk" style="color:#fff;">Network Name</a></li>
                                <li><a href="#" id="test" style="color:#fff;">No. Of Domain</a></li>
                            <span id="loadingbar" style="float:right;padding:5px;"></span>
                            </ul>
                        </div>
     ...
     echo @$body_content; ?></div>
             ...
             <input type="hidden" id="nval" value="">
                    <span class="previous"><i class="fa fa-caret-left"></i></span><span class="next-btn"><i id="" class="fa fa-caret-right"></i></span>
                     Page <input name="page" id="page" type="text" value="" readonly> of 
                </div>
               </div>-->
                           <div class="lvspag-pagination" id="lvspag-pagination" style="display:none;">
                                <span id="pager"> </span>
                                <ul>
                                    <li><a href="javascript:void(0)" class="active" id="next" onclick="NextThumb()">NEXT</a></li>
                                    <li><a href="javascript:void(0)" id="prvs" onclick="PrvsThumb()">PREVIOUS</a></li>
                                </ul>
                            </div>
							 
							<div class="lvspag-pagination" id = "lvspag-pagination_live" style="display:none;">
                                <span id="pager_live"> </span>
                                <ul>
                                    <li><a href="javascript:void(0)" class="active" id="next" onclick="NextThumb('live')">NEXT</a></li>
                                    <li><a href="javascript:void(0)" id="prvs" onclick="PrvsThumb('live')">PREVIOUS</a></li>
                                </ul>
                            </div>
                            <div class="clearfix"></div>
                        </div>
...
function NextThumb(elem){

if($('#total_page').html() != $('#next_item').html()){
$('#next').addClass('active');
$('#prvs').addClass('active');
		var form_data = {
			id : $('#selectblogtype1').val(),
			ajax : '1',
			page_start : $('#next_item').html()
		};
		if(elem=='live'){
		$('#loadingbar').html('<img id="loadingdomain" style="margin-left: auto;margin-right: auto" src="http://serpavenger.com/serp_avenger/images/LoadingAnimation.GIF"  />');
	...
	$('#loadingbar').html(' ');
			// 2nd Ajax call for domain list 
					if(elem=='live'){
					var URL = '<?php echo base_url(); ?>index.php/mypannel/get_network_list/';
					var name = $('#test').html();
					var i;
					var res = name.split(" ");
					var html_t =''; 
					for(i=1;i<=parseInt(res[0]);i++){
					
						if(i<=17){						
							if(i==1){
								html_t += "<div class='toplvs-listing'><div class='sitethumb-list' style='position:relative'>";
								
								if(parseInt(res[0])>6)
								html_t +=  "<a href='javascript:void(0)' class='prev-btn_p' onclick='PrvsThumb(&quot;live&quot;)'><img src='http://serpavenger.com/serp_avenger/images/prev-btn_p.png' width='58' height='59' ></a><a href='javascript:void(0)' class='next-btn_p' onclick='NextThumb(&quot;live&quot;)'><img src='http://serpavenger.com/serp_avenger/images/next-btn_p.png' width='58' height='59' ></a>";
								
								html_t += "<ul>";
							}
							if(i==12)
								html_t += "<div class='toplvs-listing'><div class='sitethumb-list'><ul>";
							if(i==7)
								html_t += "<ul><li style='width:70px;'></li>";
								
							html_t += '<li><a href="#" class="image-link"><img id="" src="<?php echo base_url(); ?>images/Thumbnail-Queued.jpg" width="120" height="90" /></li>';
				...
				$('.sitethumb-list').html(html_t);	
					
					
					
					}
					else
					var URL = '<?php echo base_url(); ?>index.php/mypannel/get_network_domain_from_db/';
					 $('#def').css('display','none');
					//$('.sitethumb-list').html('<img id="loadingdomain" style="margin-left: auto;margin-right: auto" src="<?php echo base_url(); ?>images/ajax-loader.gif"  />');
					document.getElementById("selectblogtype1").disabled=true;
							$.ajax({
							...
							if(elem=='live'){							
									...
									eval("$('.image-link').magnificPopup({type:'image',image: {cursor: ''}})");
									if(elem=='live')
										eval("$('#pager_live').html(($('#pagerphp').html()))");	
									else
										eval("$('#pager').html(($('#pagerphp').html()))");
...
function PrvsThumb(elem){

var prvs = ($('#prvs_item').html()-1);
if(prvs==0)
$('#prvs').removeClass('active');
if(prvs > -1){
$('#next').addClass('active');
$('#prvs').addClass('active');
...
$('#loadingbar').html('<img id="loadingdomain" style="margin-left: auto;margin-right: auto" src="http://serpavenger.com/serp_avenger/images/LoadingAnimation.GIF"  />');
//$("#loadingdomain").show();
	//$('.sitethumb-list').html('<img id="loadingdomain" style="margin-left: auto;margin-right: auto" src="http://serpavenger.com/serp_avenger/images/LoadingAnimation.GIF"  />');
	var id = $("#selectblogtype1").val();
...
$.ajax({
				...
				document.getElementById("selectblogtype1").disabled=false;
				$('#lvspag-pagination').hide();
				$('#lvspag-pagination_live').show();
				}, 20000);
...
$(document).ready(function() {
  ...
  var imgsrc = $('#campaign_murl_thumb').attr('src');
  $('#campaign_murl_thumb').attr('src', 'http://serpavenger.com/serp_avenger/images/Thumbnail-Queued.jpg');
  setTimeout(function(){
  $('#campaign_murl_thumb').attr('src', imgsrc+'#');
  }, 15000);
 });
</script>
