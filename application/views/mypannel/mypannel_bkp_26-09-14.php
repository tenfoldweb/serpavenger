			...
			success: function(name)
				{
					...
					$('.sitethumb-list').html('<img id="loadingdomain" style="margin-left: auto;margin-right: auto" src="<?php echo base_url(); ?>images/ajax-loader.gif"  />');
							...
							success: function(data)
							{
									...
									eval("$('.image-link').magnificPopup({type:'image'})");
									}, 4000);
...
$ul = $('<ul class="carousel-inner clearfix"></ul>'+'<a href="#" class="carousel-left"></a> <a href="#" class="carousel-right"></a>').appendTo('#campaignchieldthumb');
