                    ...
                    <div class="processmain-blk">
                        ...
                        <?php
                                    ...
                                    <div class="drpright  wht-ser-eng">
                                                        ...
                                                        <div class="droptextd left3text">
                                                         <div class="checkbox12">
                                                               <input id="isCrawlByGoogle" name="isCrawlByGoogle" class="css-checkbox" type="checkbox" checked="checked" value="Yes" <?php if(isset($_POST['isCrawlByGoogle']) && $_POST['isCrawlByGoogle']== 'Yes'){echo 'CHECKED';}?>>
                                                               <label class="label-chkbx lite-gray-check" for="isCrawlByGoogle" name="checkbox1_lbl"></label>
                                                                ...
                                                                <div class="dropdown">
                                                                    <select class="dropdown-select" name="google_se_domain" id="google_se_domain">
                                                             ...
                                                             <div class="droptextd left3text">
                                                                <div class="checkbox12">
                                                               <input id="isCrawlByBing" name="isCrawlByBing" class="css-checkbox" type="checkbox" checked="checked" value="Yes" <?php if(isset($_POST['isCrawlByBing']) && $_POST['isCrawlByBing']== 'Yes'){echo 'CHECKED';}?>>
                                                               <label class="label-chkbx lite-gray-check" for="isCrawlByBing" name="checkbox1_lbl"></label>
                                                                ...
                                                                <div class="dropdown">
                                                                    <select class="dropdown-select" name="bing_se_domain" id="bing_se_domain">
                                                                        <option value="">Select Country</option>  
                                                                   <?php
                                                             ...
                                                             <div class="droptextd left3text">
                                                            <div class="checkbox12">
                                                               <input id="isCrawlByYahoo" name="isCrawlByYahoo" class="css-checkbox" type="checkbox" checked="checked" value="Yes" <?php if(isset($_POST['isCrawlByYahoo']) && $_POST['isCrawlByYahoo']== 'Yes'){echo 'CHECKED';}?>>
                                                               <label class="label-chkbx lite-gray-check" for="isCrawlByYahoo" name="checkbox1_lbl"></label>
                                                                ...
                                                                <div class="dropdown">
                                                                    <select class="dropdown-select" name="yahoo_se_domain" id="yahoo_se_domain">
                                                                        <option value="">Select Country</option>  
                                                                        <?php
                                    ...
                                    <div class="col-md-6">
                                     <h2>Track Exact URL only?</h2>
                                    	<div class="pull-left mar-top">
                                                ...
                                                <label class="type-of-size"><input type="checkbox" name="campaign_exact_url_track" id="campaign_exact_url_track2" class="boxselect" value="No">No show all of my pages ranking.</label>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>                      
                               ...
                               <div class="compaign-button-area">
                                 <span><img src="<?php echo base_url(); ?>images/loader.gif" class="mgrbtm" width="71" height="14" alt=""/></span>
                               	 <button class="btn btn-primary" name="subLogin" id="subLogin" type="submit">Next</button>
                               </div> 
                            </div>
                        </div>
