...
<?php
$campaign_id = $userdetailcompare->id;
require("apifolder/GrabzItClient.class.php");
//error_reporting(1);
	/* Changes By Ravi for image manipulation */
...
{
  //sleep(2);
  //$img_src = base_url()."images/screenshots/".str_replace("ZGIzY2JmNDNkOWY3NGYwNWJjNjkyYTM5MzI4MmUwMTU=", "", $id1).".jpg";
//echo '<img id="img1" src="'.$img_src.'" width="200"  height="150" />';
    echo '<img id="img1" src="assets/images/waiting_thumbnail.jpg" width="200"  height="150" />';
...
<span class="smalltext">(This is my most important KW)</span> 
    ...
    <tr>
      ...
      <td align="left">
      	<span class="textgrey" id="total-secondary">
        <?php 

		//print_r($keywordsec['keyword']); 
          echo $secondkeyword; ?></span><br/>
<span class="smalltext">(Next most important KW)</span> 
                        ...
                        <tr>
                         ...
                         <?php  if(is_array($campaign_cpc_detail) && count($campaign_cpc_detail) > 0){
                          ...
                          $i++){
                             ?>
                        <tr>
                          <td><input type="checkbox" value='<?php echo stripslashes($kcpcData[$i]['0']); ?>' id="chckkeyword" style="width:14px" onclick="mysecondFunction(this.value);"></td>
                          <td> 
        <?php echo stripslashes($kcpcData[$i]['0']); ?></td>
                          <td><?php echo stripslashes($kcpcData[$i]['1']);?></td>
                          <td><?php echo stripslashes($kcpcData[$i]['2']); ?></td>
    ...
    <tr>
      ...
      <td align="left">
      	<span  class="textgrey" id="total-supporting"><?php echo($additionalkeyword); ?></span><br>
...
<a onclick="javascript:void(0);">
  <span class="smlrkeywrd" data-val="<?php echo $kcpcData[$i]['1']*$kcpcData[$i]['2'];?>"><?php echo stripslashes($kcpcData[$i]['0']);?></span>
        <span class="esttrfic"><?php echo stripslashes($kcpcData[$i]['2']);?></span>
        <span class="cpc"><?php echo stripslashes($kcpcData[$i]['1']);?></span>
</a>
	<!-- <a href="#tabs-1">
...
<div class="clearfix"></div>  
<button class="btn btn-primary"  name="subLogin" id="subLogin" type="button" onclick="parent.location='<?php echo base_url();?>analyzecompare2/';">Next</button>
</div>
<div class="clearfix"></div>
</div>
...
<?php
/*ShowcronList(<?php $session = $this->session->userdata('user_data');       echo $users_id = $session['user_id']; ?>);*/
?>
...
$(".smlrkeywrd").click(function() {
    $(".smlrkeywrd").parents().removeClass('sel');
...
setTimeout(function() {
      $("#img1").attr("src", "images/screenshots/<?php echo str_replace("YjMzMjFlZWY4Y2U4NDRhNWFmZWIxM2U5Nzc0YmNjNDQ=", "", $id1); ?>.jpg");
}, 10000);
