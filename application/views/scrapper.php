...
$(document).ready(function(){
	...
	$('input[name=choose_generic_title]').click(function(){
      
	var opt = $('input[name=choose_generic_title]:checked').val();
...
<?php endif;?>
<form id="scrpForm" method="post" action="<?php echo base_url()?>index.php/scrapper/form" enctype="multipart/form-data">
...
<div class="tab-pane active tab_con" id="new_sub">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table tblheadlft">
      <tr>
        ...
        <td>
        	<div class="dropdown">
                                    <select id="dropdown" name="selectnetwork" class="dropdown-select" style="width:200px; height:30px; background:#FFF">
      ...
      <tr>
        ...
        <td>
            ...
            <div class="dropdown mgr-left">
                <select id="campaign" name="campaign" class="dropdown-select">
...
<!-- 
        ...
        <div class="form_area">
            ...
            <b>Select one of the following options to have content created for you: </b>
            <div>
            <input type="radio" name="choose_generic_title" value="custom" style="float:left; width:auto; margin-top:10px" checked>&nbsp;&nbsp;&nbsp;&nbsp;<b style="float:left; width:auto; clear:none">I'll provide an Article Title; Serp Avenger will create articles related to my Article Title.</b>
            <div style="clear:both"></div>
            </div>
            <div>
            <input type="radio" name="choose_generic_title" value="autometic" style="float:left; width:auto; margin-top:10px">&nbsp;&nbsp;&nbsp;&nbsp;<b style="float:left; width:auto; clear:none">I'll provide keywords; Serp Avenger will create articles around those keywords.</b>
            <div style="clear:both"></div>
            </div>
            
            <div id="custom" class="title_type">
            <b>Generic Title</b>
            <p>(Please use your keyword or related keyword in your title)</p>
            <p>IE: Hair Loss can be prevented by using vibe shampoo.</p>
            <input type="text" name="generic_title" placeholder="Enter my Article Title here. (please use your keyword)">
            </div>
            
            <div id="autometic" class="title_type">
